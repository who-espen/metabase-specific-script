 ...
 * Variable to rename v_espen_bw_sch_sth_mid_term_evaluation_1_school_v2_1, v_espen_bw_sch_sth_mid_term_evaluation_2_participant_v2_1
 */
SELECT
...
FROM v_espen_bw_sch_sth_mid_term_evaluation_1_school_v2_1 c
JOIN v_espen_bw_sch_sth_mid_term_evaluation_2_participant_v2_1 p ON p.p_school_id::INT = c.w_school_id
