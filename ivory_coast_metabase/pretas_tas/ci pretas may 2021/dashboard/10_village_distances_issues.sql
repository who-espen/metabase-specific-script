 ...
 * Variable to rename v_espen_ci_lf_pretas_1_site_202105_v3, <%village_dist_required%>
 */
SELECT
...
FROM v_espen_ci_lf_pretas_1_site_202105_v3 src
  JOIN v_espen_ci_lf_pretas_1_site_202105_v3 dest on (
