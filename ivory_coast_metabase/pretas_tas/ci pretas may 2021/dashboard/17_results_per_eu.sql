 ...
 * Variable to rename <%v_ab_cde_fgh_2_participant%>, espen_ci_lf_pretas_1_site_202105_v3
 */
 SELECT
c.code_site "Site ID",
c.ue "EU",
...
LEFT JOIN public.v_espen_ci_lf_pretas_1_site_202105_v3 c on d.code_site = c.code_site
