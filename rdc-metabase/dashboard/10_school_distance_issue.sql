 ...
 * Variable to rename v_espen_cd_sch_sth_baseline_1_school_202202_v2_1, <%village_dist_required%>
 */
SELECT
...
FROM v_espen_cd_sch_sth_baseline_1_school_202202_v2_1 src
  JOIN v_espen_cd_sch_sth_baseline_1_school_202202_v2_1 dest on (
