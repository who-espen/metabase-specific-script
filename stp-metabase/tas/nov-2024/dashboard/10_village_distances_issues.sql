 ...
 * Variable to rename espen_ng_lf_tas2_202412_1_s_ben_oy, <%village_dist_required%>
 */
SELECT
...
FROM espen_ng_lf_tas2_202412_1_s_ben_oy src
  JOIN espen_ng_lf_tas2_202412_1_s_ben_oy dest on (
