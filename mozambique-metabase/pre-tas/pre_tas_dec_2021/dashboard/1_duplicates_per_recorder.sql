 ...
 * Variable to rename metabase_lf_tas_duplicates_202112? espen_mz_lf_pretas_3_resultat_fts_202111_2_1
 */
 SELECT
  "Gravadors",
...
FROM (
  SELECT
    ...
    FROM public.metabase_lf_tas_duplicates_202112 m
    JOIN v_espen_mz_lf_pretas_3_resultat_fts_202111_2_1 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_lf_tas_duplicates_202112 m
    JOIN v_espen_mz_lf_pretas_2_participant_202111_v2_1 p ON p.id = m.id_participant
