 ...
 * Variable to rename metabase_mz_lf_pretas_duplicates_202212, espen_mz_lf_pretas_3_resultat_fts_202209_v1, update_lf_tas_orphaned_table_from_diag_result_202212
 */
 SELECT
 COUNT(barcode_participant),
 p.p_start::date
FROM metabase_mz_lf_pretas_duplicates_202212 AS m, v_espen_mz_lf_pretas_2_participant_202209_v1 AS p
...
SELECT
 ...
 d.d_start::date
FROM metabase_mz_lf_pretas_duplicates_202212 AS m, v_espen_mz_lf_pretas_3_resultat_fts_202209_v1 AS d
