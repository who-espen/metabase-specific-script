 ...
 * Variable to rename update_lf_tas_orphaned_table_from_diag_result_202212, <%village_dist_required%>
 */
SELECT
  ...
  src.c_cluster_id "Código do site 1",
  src.c_cluster_name "Site 1",
  dest.c_recorder "Código do Operador 2",
  dest.c_cluster_id "Código do site 2",
...
FROM v_espen_mz_lf_pretas_1_site_202209_v1 src
  JOIN v_espen_mz_lf_pretas_1_site_202209_v1 dest on (
