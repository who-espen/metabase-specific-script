 ...
 * Variable to rename v_espen_mz_lf_tas1_2_participant_202209_v1, v_espen_mz_lf_tas1_3_resultat_fts_202209_v1, metabase_mz_lf_tas_orphaned_202209
 */

    SELECT
      p.p_cluster_id "Código do site",
      NULL "Nome do site",
      p_barcode_id "ID do participante",
    ...
    FROM v_espen_mz_lf_tas1_2_participant_202209_v1 p
      ...
      LEFT JOIN metabase_mz_lf_tas_orphaned_202209 m on m.id_participant = p.id
    ...
    FROM v_espen_mz_lf_tas1_3_resultat_fts_202209_v1 d
      LEFT JOIN v_espen_mz_lf_tas1_2_participant_202209_v1 p on p.p_barcode_id = d.d_barcode_id
      LEFT JOIN metabase_mz_lf_tas_orphaned_202209 m on m.id_results = d.id
