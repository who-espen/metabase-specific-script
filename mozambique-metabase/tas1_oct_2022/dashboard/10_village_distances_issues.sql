 ...
 * Variable to rename espen_mz_lf_tas1_1_site_202209_v1, <%village_dist_required%>
 */
SELECT
...
FROM v_espen_mz_lf_tas1_1_site_202209_v1 src
  JOIN v_espen_mz_lf_tas1_1_site_202209_v1 dest on (
