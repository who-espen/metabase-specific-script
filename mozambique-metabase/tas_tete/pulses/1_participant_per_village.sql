 ...
 * Variable to rename espen_mz_lf_tas2_2_participant_202101, espen_mz_lf_tas2_2_participant_202101
 */
 SELECT
...
FROM espen_mz_lf_tas2_2_participant_202101 c
LEFT JOIN espen_mz_lf_tas2_2_participant_202101 p ON c.c_cluster_id = p.p_cluster_id::INT

where p.p_end > CURRENT_end - 1
