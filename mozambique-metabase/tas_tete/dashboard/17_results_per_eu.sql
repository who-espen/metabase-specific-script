 ...
 * Variable to rename espen_mz_lf_tas2_2_participant_202101, update_lf_tas_orphaned_table_from_diag_result_202101
 */
 SELECT
...
LEFT JOIN update_lf_tas_orphaned_table_from_diag_result_202101 c on d.d_cluster_id::int = c.c_cluster_id
RIGHT JOIN espen_mz_lf_tas2_2_participant_202101 p on p.p_code_id = d.d_code_id
