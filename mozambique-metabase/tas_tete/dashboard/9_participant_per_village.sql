 ...
 * Variable to rename update_lf_tas_orphaned_table_from_diag_result_202101, espen_mz_lf_tas2_2_participant_202101
 */
SELECT
...
JOIN v_espen_mz_lf_tas2_2_participant_202101 p ON p.p_cluster_id = c.c_cluster_id
