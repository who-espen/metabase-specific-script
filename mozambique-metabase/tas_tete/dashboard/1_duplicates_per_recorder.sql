 ...
 * Variable to rename metabase_lf_tas_duplicates_202101? espen_mz_lf_tas2_3_resultat_fts_202101
 */
 SELECT
  "Gravadors",
...
FROM (
  SELECT
    ...
    FROM public.metabase_lf_tas_duplicates_202101 m
    JOIN v_espen_mz_lf_tas2_3_resultat_fts_202101 d ON d.id = m.id_results
