 ...
 * Variable to rename update_lf_tas_orphaned_table_from_diag_result_202101, <%village_dist_required%>
 */
SELECT
...
FROM v_espen_mz_lf_tas2_1_site_202101 src
  JOIN v_espen_mz_lf_tas2_1_site_202101 dest on (
