 ...
 * Variable to rename metabase_lf_tas_duplicates_202012? espen_mz_lf_tas1_3_resultat_fts_202011_v3
 */
 SELECT
  "Gravadors",
...
FROM (
  SELECT
    ...
    FROM public.metabase_lf_tas_duplicates_202012 m
    JOIN v_espen_mz_lf_tas1_3_resultat_fts_202011_v3 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_lf_tas_duplicates_202012 m
    JOIN espen_mz_lf_tas1_2_participant_202011_v3 p ON p.id = m.id_participant
