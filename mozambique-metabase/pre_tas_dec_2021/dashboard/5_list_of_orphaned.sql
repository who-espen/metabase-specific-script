 ...
 * Variable to rename espen_mz_lf_pretas_2_participant_202111_v2_1, v_espen_mz_lf_pretas_3_resultat_fts_202111_2_1, metabase_lf_tas_orphaned_202112
 */
    ...
    FROM espen_mz_lf_pretas_2_participant_202111_v2_1 p
      ...
      LEFT JOIN metabase_lf_tas_orphaned_202112 m on m.id_participant = p.id
    ...
    FROM v_espen_mz_lf_pretas_3_resultat_fts_202111_2_1 d
      LEFT JOIN espen_mz_lf_pretas_2_participant_202111_v2_1 p on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_lf_tas_orphaned_202112 m on m.id_results = d.id
