 ...
 * Variable to rename update_lf_tas2_orphaned_table_from_diag_result_202112, <%village_dist_required%>
 */
SELECT
...
FROM v_espen_mz_lf_tas2_1_site_202111_v2 src
  JOIN v_espen_mz_lf_tas2_1_site_202111_v2 dest on (
