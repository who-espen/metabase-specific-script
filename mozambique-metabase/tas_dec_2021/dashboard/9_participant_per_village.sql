 ...
 * Variable to rename update_lf_tas2_orphaned_table_from_diag_result_202112, espen_mz_lf_tas2_2_participant_202111_v2_1
 */
SELECT
...
JOIN v_espen_mz_lf_tas2_2_participant_202111_v2_1 p ON p.p_cluster_id = c.c_cluster_id

WHERE p.id IS NOT NULL

GROUP BY c_recorder, c_cluster_id, c_eu, c_population, c_cluster_name
