...
LEFT JOIN update_lf_tas2_orphaned_table_from_diag_result_202112 c on d.d_cluster_id::int = c.c_cluster_id
RIGHT JOIN espen_mz_lf_tas2_2_participant_202111_v2_1 p on p.p_code_id = d.d_code_id
