 ...
 * Variable to rename v_espen_demo_lf_itas_9999_3_fts_v2, v_espen_demo_lf_itas_9999_3_fts, metabase_demo_lf_tas_orphaned_202405
 */
    ...
    FROM v_espen_demo_lf_itas_9999_3_fts_v2 p
    ...
    FROM v_espen_demo_lf_itas_9999_3_fts d
      LEFT JOIN v_espen_demo_lf_itas_9999_3_fts_v2 p on p.p_code_id = d.d_code_id
