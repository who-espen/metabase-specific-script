 ...
 * Variable to rename metabase_demo_lf_9999_itas_duplicates? espen_demo_lf_tas_202405_3_resultat_fts_jgw_v3
 */
...
FROM (
  SELECT
    ...
    FROM public.metabase_demo_lf_9999_itas_duplicates m
    JOIN v_espen_demo_lf_itas_9999_3_fts d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_demo_lf_9999_itas_duplicates m
    JOIN v_espen_demo_lf_itas_9999_3_fts_v2 p ON p.id = m.id_participant
