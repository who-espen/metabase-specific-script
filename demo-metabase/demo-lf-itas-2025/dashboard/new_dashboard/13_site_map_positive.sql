 ...
 * Variable to rename espen_bj_oncho_prestop_1_site,  v_espen_demo_lf_itas_9999_3_fts
 */
...
FROM v_espen_demo_lf_tas_9999_1_site_v3 as 
 c
LEFT JOIN v_espen_demo_lf_itas_9999_3_fts d on c.c_cluster_id = d.d_cluster_id
