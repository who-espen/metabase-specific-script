...
FROM
    public.metabase_demo_lf_9999_itas_duplicates m
    JOIN v_espen_demo_lf_itas_9999_3_fts k ON k.id = m.id_results_fts :: int
...
FROM
    public.metabase_demo_lf_9999_itas_duplicates m
    JOIN v_espen_demo_lf_tas_9999_1_site_v3 as 
 p ON (p.id = m.id_participant:: int)
