 ...
 * Variable to rename metabase_demo_lf_9999_itas_duplicates, espen_demo_lf_tas_202405_3_resultat_fts_jgw_v3, espen_demo_lf_tas_202405_2_part_ben_oy_v2
 */
 SELECT
 COUNT(barcode_participant) "Total duplicates",
 p.p_start::date "Date"
FROM metabase_demo_lf_9999_itas_duplicates AS m, v_espen_demo_lf_itas_9999_3_fts_v2 AS p
...
SELECT
 ...
 d.d_start::date "Date"
FROM metabase_demo_lf_9999_itas_duplicates AS m, v_espen_demo_lf_itas_9999_3_fts AS d
