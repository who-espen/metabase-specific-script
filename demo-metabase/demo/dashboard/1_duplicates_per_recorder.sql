 ...
 * Variable to rename metabase_ng_lf_pretas_duplicates_202212? espen_ng_lf_pretas_3_resultat_fts_202102_v2_1
 */
...
FROM (
        ...
        FROM
            public.metabase_ng_lf_pretas_duplicates_202212 m
            JOIN v_espen_ng_lf_pretas_3_resultat_fts_202102_v2_1 d ON d.id = m.id_results
        GROUP BY
            d.d_recorder_id,
            d_district,
            d_cluster_id,
        ...
        FROM
            public.metabase_ng_lf_pretas_duplicates_202212 m
            JOIN espen_ng_lf_pretas_2_participant_202102_v2_1 p ON p.id = m.id_participant
        group by
            p.p_recorder_id,
            p_district,
            p_cluster_id,
