 ...
 * Variable to rename v_espen_demo_lf_tas_9999_3_fts_v2_v2, v_espen_demo_lf_tas_9999_3_fts_v2, metabase_demo_lf_tas_orphaned_202405
 */
    ...
    FROM v_espen_demo_lf_tas_9999_3_fts_v2_v2 p
      LEFT JOIN v_espen_demo_lf_tas_9999_3_fts_v2 d on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_demo_lf_tas_orphaned_202405 m on m.id_participant = p.id
    ...
    FROM v_espen_demo_lf_tas_9999_3_fts_v2 d
      LEFT JOIN v_espen_demo_lf_tas_9999_3_fts_v2_v2 p on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_demo_lf_tas_orphaned_202405 m on m.id_results = d.id
