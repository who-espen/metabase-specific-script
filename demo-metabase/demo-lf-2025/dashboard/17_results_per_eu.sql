 ...
 * Variable to rename v_espen_demo_lf_tas_9999_3_fts_v2_v2, espen_demo_lf_tas_202405_1_s_ben_oy
 */
 SELECT
...
LEFT JOIN espen_demo_lf_tas_202405_1_s_ben_oy c on d.d_cluster_id::int = c.c_cluster_id
RIGHT JOIN v_espen_demo_lf_tas_9999_3_fts_v2_v2 p on p.p_code_id = d.d_code_id
