 ...
 * Variable to rename espen_demo_lf_tas_202405_1_s_ben_oy, <%village_dist_required%>
 */
SELECT
...
FROM espen_demo_lf_tas_202405_1_s_ben_oy src
  JOIN espen_demo_lf_tas_202405_1_s_ben_oy dest on (
