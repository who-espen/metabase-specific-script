 ...
 * Variable to rename v_espen_demo_lf_tas_9999_2_part_v2, v_espen_demo_lf_tas_9999_3_fts_v2
 */
...
FROM v_espen_demo_lf_tas_9999_2_part_v2 p
  LEFT JOIN v_espen_demo_lf_tas_9999_3_fts_v2 d on d.d_code_id = p.p_code_id
