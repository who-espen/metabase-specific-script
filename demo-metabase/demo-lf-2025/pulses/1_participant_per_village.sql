 ...
 * Variable to rename v_espen_demo_lf_tas_9999_3_fts_v2_v2, v_espen_demo_lf_tas_9999_3_fts_v2_v2
 */
 SELECT
...
FROM v_espen_demo_lf_tas_9999_3_fts_v2_v2 c
LEFT JOIN v_espen_demo_lf_tas_9999_3_fts_v2_v2 p ON c.c_cluster_id = p.p_cluster_id::INT
