...
FROM
    ...
    LEFT JOIN espen_ng_lf_pretas_1_site_202102_v2_1 c on d.d_cluster_id:: int = c.c_cluster_id
    RIGHT JOIN v_espen_ng_lf_pretas_2_participant_202102_v2_1 p on p.p_code_id = d.d_code_id
WHERE
