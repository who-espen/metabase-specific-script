 ...
 * Variable to rename metabase_ng_lf_pretas_duplicates_202212, v_espen_ng_lf_pretas_2_participant_202102_v2_1, v_espen_ng_lf_pretas_3_resultat_fts_202102_v2_1
 */
...
FROM (
        SELECT
            ...
            status "Status"
        FROM
            metabase_ng_lf_pretas_duplicates_202212 AS m,
            v_espen_ng_lf_pretas_2_participant_202102_v2_1 AS p
        WHERE
        ...
        FROM
            metabase_ng_lf_pretas_duplicates_202212 AS m,
            v_espen_ng_lf_pretas_3_resultat_fts_202102_v2_1 AS d
        WHERE
            d.id = m.id_results
    ) src
