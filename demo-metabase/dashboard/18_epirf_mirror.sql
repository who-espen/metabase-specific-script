 ...
 * Variable to rename Pre TAS, v_espen_ng_lf_pretas_3_resultat_fts_202102_v2_1, v_espen_ng_lf_pretas_2_participant_202102_v2_1,
...
FROM
    ...
    JOIN espen_ng_lf_pretas_1_site_202102_v2_1 c on d.d_cluster_id = c.c_cluster_id
    JOIN v_espen_ng_lf_pretas_2_participant_202102_v2_1 p on p.p_code_id = d.d_code_id
GROUP BY
    c_district,
    c_cluster_name,
    "Month",
