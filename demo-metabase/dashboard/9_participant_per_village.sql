 ...
 * Variable to rename espen_ng_lf_pretas_1_site_202211_v1, v_espen_ng_lf_pretas_2_participant_202211
 */
SELECT
...
JOIN v_espen_ng_lf_pretas_2_participant_202211 p ON p.p_cluster_id = c.c_cluster_id
