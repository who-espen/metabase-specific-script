 ...
 */
-- public.v_espen_cg_oncho_oem_202303_1_site_dbs source

-- CREATE OR REPLACE VIEW public.v_espen_cg_oncho_oem_202303_1_site_dbs AS 
SELECT
...
FROM (
      SELECT
      	...
      	"Code Village" ,
      	"Village"
      FROM metabase_oncho_cg_oem_202304_duplicates m, public.v_espen_cg_oncho_oem_202303_1_site_dbs p
      ...
      SELECT
      	...
      	"Code Village",
      	 "Village"
      FROM metabase_oncho_cg_oem_202304_duplicates m, public.v_espen_cg_oncho_oem_202303_2_biopsiev_2 d
