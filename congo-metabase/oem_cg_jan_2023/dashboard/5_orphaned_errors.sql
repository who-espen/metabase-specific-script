 ...
 * Variable to rename v_espen_cg_oncho_oem_full_202112, v_espen_cg_oncho_oem_202303_2_biopsiev_2, metabase_cg_oncho_oem_orphaned_202304
 */
    ...
    FROM v_espen_cg_oncho_oem_full_202112 p
      LEFT JOIN v_espen_cg_oncho_oem_202303_2_biopsiev_2 d on p.p_barcode_id = d.barcode_id
      LEFT JOIN metabase_cg_oncho_oem_orphaned_202304 m on m.id_participant = p.id
      WHERE d.id isNULL
  ...
  -- [[and {{date}}]]
    ...
    FROM v_espen_cg_oncho_oem_202303_2_biopsiev_2 d
      LEFT JOIN v_espen_cg_oncho_oem_full_202112 p on p.p_barcode_id = d.barcode_id
      LEFT JOIN metabase_cg_oncho_oem_orphaned_202304 m on m.id_results = d.id
      WHERE p.id isNULL
