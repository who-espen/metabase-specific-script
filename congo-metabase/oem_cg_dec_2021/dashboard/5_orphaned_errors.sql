 ...
 * Variable to rename v_espen_cg_oncho_oem_full_202112, <%v_ab_cde_fgh_3_rdt_ov16%>, <%metabase_oncho_oem_orphaned_202004%>
 */
  ...
  -- [[and {{date}}]]
    ...
    FROM <%v_ab_cde_fgh_3_rdt_ov16%> d
      LEFT JOIN v_espen_cg_oncho_oem_full_202112 p on p.p_barcode_id = d.d_barcode_id
