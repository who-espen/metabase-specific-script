 ...
 * Variable to rename metabase_oncho_cg_oem_202310_duplicates, v_espen_cg_oncho_oem_full_202112
 */
 SELECT
 COUNT(barcode_participant),
 created_at::date
FROM metabase_oncho_cg_oem_202310_duplicates AS m, v_espen_cg_oncho_oem_202310_1_site_dbs_v4_1 AS p
