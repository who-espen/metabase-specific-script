 ...
 */
CREATE OR REPLACE VIEW v_espen_tg_sch_sth_impact_6_controle_urine_202110
AS SELECT u1.meta_instance_id,
    ...
    u1.created_at,
    u1.updated_at
   FROM public.espen_tg_sch_sth_impact_6_controle_urine_202110 u1
...
UNION ALL
 ...
 SELECT u2.meta_instance_id,
    ...
    u2.created_at,
    u2.updated_at
   FROM public.espen_tg_sch_sth_impact_6_controle_urine_202110_v6_2 u2
  ORDER BY u_start;
