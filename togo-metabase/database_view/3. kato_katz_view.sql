 ...
 */
CREATE OR REPLACE VIEW public.v_espen_tg_sch_sth_impact_3_kato_katz_202110_v6
AS SELECT k1.meta_instance_id,
    ...
    k1.created_at,
    k1.updated_at
   FROM espen_tg_sch_sth_impact_3_kato_katz_202110_v6 k1
UNION ALL
 SELECT k2.meta_instance_id,
    ...
    k2.created_at,
    k2.updated_at
   FROM espen_tg_sch_sth_impact_3_kato_katz_202110_v6_2 k2
  ORDER BY k_start;