...
/*
 * Variable to rename  v_espen_tg_sch_sth_impact_4_urine_filtration_202110_v6, v_espen_tg_sch_sth_impact_4_urine_filtration_202110_v6
 */
CREATE OR REPLACE VIEW public.v_espen_tg_sch_sth_impact_4_urine_filtration_202110_v6
AS SELECT u1.meta_instance_id,
    ...
    u1.created_at,
    u1.updated_at
   FROM espen_tg_sch_sth_impact_4_urine_filtration_202110_v6 u1
...
UNION ALL
 ...
 SELECT u2.meta_instance_id,
    ...
    u2.created_at,
    u2.updated_at
   FROM espen_tg_sch_sth_impact_4_urine_filtration_202110_v6_2 u2
  ORDER BY 15;
