 ...
 * Variable to rename v_espen_tg_oncho_stop_1_site_202209_v1, v_espen_tg_oncho_stop_2_participants_202209_v1
 */
 SELECT
...
LEFT JOIN v_espen_tg_oncho_stop_2_participants_202209_v1 p ON c.c_site_id = p.p_site_id::INT
