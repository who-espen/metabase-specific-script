 ...
 * Variable to rename espen_tg_oncho_stop_1_site_202209_v1, <%village_dist_required%>
 */
SELECT
...
FROM espen_tg_oncho_stop_1_site_202209_v1 src
  JOIN espen_tg_oncho_stop_1_site_202209_v1 dest on (
