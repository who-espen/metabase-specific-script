 ...
 * Variable to rename v_espen_tg_oncho_stop_2_participants_202209_v1, v_espen_tg_oncho_stop_3_elisa_202209_v1, metabase_oncho_stop_orphaned_202211
 */
    ...
    FROM v_espen_tg_oncho_stop_2_participants_202209_v1 p
      ...
      LEFT JOIN metabase_oncho_stop_orphaned_202211 m on m.id_participant = p.id
      WHERE d.id isNULL
  ...
  -- [[and {{date}}]]
    ...
    FROM v_espen_tg_oncho_stop_3_elisa_202209_v1 d
      LEFT JOIN v_espen_tg_oncho_stop_2_participants_202209_v1 p on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_oncho_stop_orphaned_202211 m on m.id_results = d.id
      WHERE p.id isNULL
