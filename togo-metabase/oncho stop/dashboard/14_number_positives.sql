 ...
 * Variable to rename v_espen_tg_oncho_stop_2_participants_202204, v_espen_tg_oncho_stop_3_elisa_202204
 */
 SELECT
...
FROM v_espen_tg_oncho_stop_2_participants_202204 p
  LEFT JOIN v_espen_tg_oncho_stop_3_elisa_202204 d on d.d_code_id = p.p_code_id
