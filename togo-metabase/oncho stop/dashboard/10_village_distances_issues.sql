 ...
 * Variable to rename espen_tg_oncho_stop_1_site_202204, <%village_dist_required%>
 */
SELECT
...
FROM espen_tg_oncho_stop_1_site_202204 src
  JOIN espen_tg_oncho_stop_1_site_202204 dest on (
