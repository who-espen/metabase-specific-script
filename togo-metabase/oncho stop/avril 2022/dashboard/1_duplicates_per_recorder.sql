 ...
 * Variable to rename metabase_oncho_stop_duplicates_202204? espen_tg_oncho_stop_3_elisa_202204
 */
 SELECT
...
FROM (
  SELECT
    ...
    FROM public.metabase_oncho_stop_duplicates_202204 m
    JOIN v_espen_tg_oncho_stop_3_elisa_202204 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_oncho_stop_duplicates_202204 m
    JOIN v_espen_tg_oncho_stop_2_participants_202204 p ON p.id = m.id_participant
