 ...
 * Variable to rename v_espen_tg_oncho_stop_202304_1_site, v_espen_tg_oncho_stop_202304_2_participants
 */
 SELECT
...
LEFT JOIN v_espen_tg_oncho_stop_202304_2_participants p ON c.c_site_id = p.p_site_id::INT
