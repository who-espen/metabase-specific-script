 ...
 * Variable to rename espen_tg_oncho_stop_202304_1_site, <%village_dist_required%>
 */
SELECT
...
FROM espen_tg_oncho_stop_202304_1_site src
  JOIN espen_tg_oncho_stop_202304_1_site dest on (
