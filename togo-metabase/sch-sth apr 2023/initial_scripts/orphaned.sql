...
/**
 * The table to track orphaned issues metabase_tg_202309_sch_sth_impact_orphaned, v_espen_tg_sch_sth_impact_202309_2_child_v2, v_espen_tg_sch_sth_impact_202309_3_kato_katz_v2,
...
FROM (
        ...
        FROM
            ...
            LEFT JOIN v_espen_tg_sch_sth_impact_202309_3_kato_katz_v2 k on p.p_barcodeid = k.k_barcodeid
        WHERE
            k.id isnull
...
FROM
    v_espen_tg_sch_sth_impact_202309_2_child_v2 p
    LEFT JOIN v_espen_tg_sch_sth_impact_202309_3_kato_katz_v2 d on p.p_barcodeid = d.k_barcodeid
...
FROM (
        ...
        FROM
            v_espen_tg_sch_sth_impact_202309_2_child_v2 p
            LEFT JOIN v_espen_tg_sch_sth_impact_202309_4_urine_filtration_v2_1 k on p.p_barcodeid = k.u_barcodeid
        WHERE
            k.id isnull
    ) p ON CONFLICT ON CONSTRAINT unique_idx_ml_sch_sth_impact_202309_orphaned_participant_id_barcode
DO NOTHING;
...
FROM
    v_espen_tg_sch_sth_impact_202309_2_child_v2 p
    LEFT JOIN v_espen_tg_sch_sth_impact_202309_4_urine_filtration_v2_1 d on p.p_barcodeid = d.u_barcodeid
WHERE d.id ISNULL;
...
FROM (
        ...
        FROM
            v_espen_tg_sch_sth_impact_202309_2_child_v2 p
            RIGHT JOIN v_espen_tg_sch_sth_impact_202309_3_kato_katz_v2 d on p.p_barcodeid = d.k_barcodeid
        WHERE
            p.id isnull
...
FROM (
        ...
        FROM
            v_espen_tg_sch_sth_impact_202309_2_child_v2 p
            RIGHT JOIN v_espen_tg_sch_sth_impact_202309_4_urine_filtration_v2_1 d on p.p_barcodeid = d.u_barcodeid
        WHERE
            p.id isnull
