...
FROM
    ...
    left join public.v_espen_tg_sch_sth_impact_202309_1_school_v2 w on w.w_site_name = p.p_site
    left join public.v_espen_tg_sch_sth_impact_202309_3_kato_katz_v2 k on k.k_barcodeid = p.p_barcodeid
    left join public.v_espen_tg_sch_sth_impact_202309_4_urine_filtration_v2_1 u on u.u_barcodeid = p.p_barcodeid
