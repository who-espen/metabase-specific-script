 ...
 * Variable to rename v_espen_tg_sch_sth_impact_202309_1_school_v2, <%village_dist_required%>
 */
...
FROM
    v_espen_tg_sch_sth_impact_202309_1_school_v2 src
    JOIN v_espen_tg_sch_sth_impact_202309_1_school_v2 dest on (
        SELECT
            calculate_distance(
                src.w_gps_lat,
                src.w_gps_lng,
