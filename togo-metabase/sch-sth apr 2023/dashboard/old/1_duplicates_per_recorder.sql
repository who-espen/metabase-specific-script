 ...
 * Variable to rename metabase_tg_202309_sch_sth_impact_duplicates, v_espen_tg_sch_sth_impact_202309_3_kato_katz_v2, v_espen_tg_sch_sth_impact_202309_4_urine_filtration_v2_1
 */
...
FROM (
        ...
        FROM
            ...
            JOIN v_espen_tg_sch_sth_impact_202309_3_kato_katz_v2 k ON k.id = m.id_results_kk
        GROUP BY
            k.k_recorder,
            k_district,
            k_school_id,
        ...
        FROM
            public.metabase_tg_202309_sch_sth_impact_duplicates m
            JOIN v_espen_tg_sch_sth_impact_202309_2_child_v2 p ON (p.id = m.id_participant)
        ...
        FROM
            public.metabase_tg_202309_sch_sth_impact_duplicates m
            JOIN v_espen_tg_sch_sth_impact_202309_4_urine_filtration_v2_1 u ON u.id = m.id_results_urine
        GROUP BY
            u.u_recorder,
            u_district,
            u_school_id,
