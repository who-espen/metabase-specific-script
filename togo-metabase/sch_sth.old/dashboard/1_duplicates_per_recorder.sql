 ...
 * Variable to rename metabase_sch_sth_mapping_duplicates_202110, v_espen_tg_sch_sth_impact_3_kato_katz_202110_v6, v_espen_tg_sch_sth_impact_4_urine_filtration_202110_v6
 */
 SELECT
...
FROM (
  SELECT
    ...
    FROM public.metabase_sch_sth_mapping_duplicates_202110 m
    JOIN v_espen_tg_sch_sth_impact_3_kato_katz_202110_v6 k ON k.id = m.id_results_kk
  ...
  SELECT
    ...
    FROM public.metabase_sch_sth_mapping_duplicates_202110 m
    JOIN v_espen_tg_sch_sth_impact_2_child_202110_v6 p ON (p.id = m.id_participant)
  ...
  UNION
   ...
   SELECT
    ...
    FROM public.metabase_sch_sth_mapping_duplicates_202110 m
    JOIN v_espen_tg_sch_sth_impact_4_urine_filtration_202110_v6 u ON u.id = m.id_results_urine
