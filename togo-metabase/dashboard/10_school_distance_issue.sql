 ...
 * Variable to rename v_espen_tg_sch_sth_impact_1_school_202110_v6_1, <%village_dist_required%>
 */
SELECT
...
FROM v_espen_tg_sch_sth_impact_1_school_202110_v6_1 src
  JOIN v_espen_tg_sch_sth_impact_1_school_202110_v6_1 dest on (
