...
FROM
    ...
    left join public.v_espen_tg_sch_sth_ia_202404_1_scho_ch_v3_2 c on p.p_school_id = c.w_school_id
    left join public.v_espen_tg_sch_sth_ia_202404_2_kk_v3_1 k on p.p_barcodeid = k.k_barcodeid
GROUP BY
    p_district,
    p_school_name,
    p_start,
