...
/*
 * Variable to rename <%metabase_oncho_oem_orphaned_202004%>, v_espen_bj_oncho_stop_2_202306_questions_v3
 */
...
FROM (
        ...
        FROM
            v_espen_bj_oncho_stop_2_202306_questions_v3 p
            RIGHT JOIN < % v_ab_cde_fgh_3_rdt_ov16 % > d on p.p_barecode_id = d.d_barecode_id
        WHERE
            p.id isnull
