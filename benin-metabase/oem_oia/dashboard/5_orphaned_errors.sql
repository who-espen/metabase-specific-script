 ...
 * Variable to rename v_espen_bj_oncho_prestop_2_participants, <%v_ab_cde_fgh_3_rdt_ov16%>, <%metabase_oncho_oem_orphaned_202004%>
 */
  ...
  -- [[and {{date}}]]
    ...
    FROM <%v_ab_cde_fgh_3_rdt_ov16%> d
      LEFT JOIN v_espen_bj_oncho_prestop_2_participants p on p.p_barcode_id = d.d_barcode_id
