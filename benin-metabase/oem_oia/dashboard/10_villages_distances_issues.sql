 ...
 * Variable to rename espen_bj_oncho_prestop_1_site, <%village_dist_required%>
 */
SELECT
...
FROM espen_bj_oncho_prestop_1_site src
  JOIN espen_bj_oncho_prestop_1_site dest on (
