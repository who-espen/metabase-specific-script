 ...
 * Variable to rename v_espen_bj_sch_sth_impact_202304_1_school, <%village_dist_required%>
 */
SELECT
...
FROM v_espen_bj_sch_sth_impact_202304_1_school src
  JOIN v_espen_bj_sch_sth_impact_202304_1_school dest on (
