...
left join public.v_espen_bj_sch_sth_impact_202304_1_school w on w.w_site_name = p.p_site
left join public.v_espen_bj_sch_sth_impact_202304_3_kato_katz_v1 k on k.k_espen_code_id = p.p__espen_code_id
left join public.v_espen_bj_sch_sth_impact_202304_4_urine_filtration_v1 u on u.u_barcodeid = p.p__espen_code_id

where k_espen_code_id is not null
