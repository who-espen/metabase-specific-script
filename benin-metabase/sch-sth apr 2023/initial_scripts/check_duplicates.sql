...
SELECT src.id, src.p__espen_code_id FROM v_espen_bj_sch_sth_impact_202304_2_child src
                WHERE (SELECT count (*)  FROM v_espen_bj_sch_sth_impact_202304_2_child inr WHERE src.p__espen_code_id = inr.p__espen_code_id ) > 1;
