 ...
 * Variable to rename v_espen_bj_lf_retas1_1_sites_202104_v3, v_espen_bj_lf_retas1_2_partcipants_202104_v3
 */
 SELECT
...
LEFT JOIN v_espen_bj_lf_retas1_2_partcipants_202104_v3 p ON c.c_cluster_id = p.p_cluster_id::INT
