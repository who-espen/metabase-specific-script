 ...
 * Variable to rename metabase_bj_lf_retas1_duplicates_202105_2? espen_bj_lf_retas1_3_fts_result_202104_v3
 */
 SELECT
  "Opérateurs",
...
FROM (
  SELECT
    ...
    FROM public.metabase_bj_lf_retas1_duplicates_202105_2 m
    JOIN v_espen_bj_lf_retas1_3_fts_result_202104_v3 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_bj_lf_retas1_duplicates_202105_2 m
    JOIN v_espen_bj_lf_retas1_2_partcipants_202104_v3 p ON p.id = m.id_participant
