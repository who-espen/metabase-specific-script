 ...
 * Variable to rename espen_bj_lf_retas1_1_sites_202104_v3, <%village_dist_required%>
 */
SELECT
...
FROM espen_bj_lf_retas1_1_sites_202104_v3 src
  JOIN espen_bj_lf_retas1_1_sites_202104_v3 dest on (
