 ...
 * Variable to rename espen_bj_lf_tas2_4_sites_202104, <%village_dist_required%>
 */
SELECT
...
FROM espen_bj_lf_tas2_4_sites_202104 src
  JOIN espen_bj_lf_tas2_4_sites_202104 dest on (
