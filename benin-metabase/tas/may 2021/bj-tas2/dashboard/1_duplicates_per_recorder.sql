 ...
 * Variable to rename metabase_bj_lf_tas2_duplicates_202105? espen_bj_lf_tas2_6_fts_result_202104_v2
 */
 SELECT
  "Opérateurs",
...
FROM (
  SELECT
    ...
    FROM public.metabase_bj_lf_tas2_duplicates_202105 m
    JOIN v_espen_bj_lf_tas2_6_fts_result_202104_v2 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_bj_lf_tas2_duplicates_202105 m
    JOIN v_espen_bj_lf_tas2_5_partcipants_202104_v2 p ON p.id = m.id_participant
