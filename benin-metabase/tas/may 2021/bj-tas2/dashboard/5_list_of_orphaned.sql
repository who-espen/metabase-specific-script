 ...
 * Variable to rename v_espen_bj_lf_tas2_5_partcipants_202104_v2, v_espen_bj_lf_tas2_6_fts_result_202104_v2, metabase_lf_tas2_orphaned_202105
 */
    ...
    FROM v_espen_bj_lf_tas2_5_partcipants_202104_v2 p
      ...
      LEFT JOIN metabase_lf_tas2_orphaned_202105 m on m.id_participant = p.id
    ...
    FROM v_espen_bj_lf_tas2_6_fts_result_202104_v2 d
      LEFT JOIN v_espen_bj_lf_tas2_5_partcipants_202104_v2 p on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_lf_tas2_orphaned_202105 m on m.id_results = d.id
