 ...
 * Variable to rename metabase_lf_pretas_duplicates_202009? espen_bj_lf_pretas_3_resultat_fts_202009_v3
 */
 SELECT
...
FROM (
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202009 m
    JOIN v_espen_bj_lf_pretas_3_resultat_fts_202009_v3 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202009 m
    JOIN espen_bj_lf_pretas_2_participant_202009_v3 p ON p.id = m.id_participant
