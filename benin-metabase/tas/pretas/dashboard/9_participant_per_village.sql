 ...
 * Variable to rename espen_bj_lf_pretas_1_site_202009_v3, v_espen_bj_lf_pretas_2_participant_202009_v3
 */
SELECT
...
JOIN v_espen_bj_lf_pretas_2_participant_202009_v3 p ON p.p_cluster_id::INT = c.c_cluster_id
