 ...
 * Variable to rename espen_bj_lf_pretas_1_site_202009_v3, <%village_dist_required%>
 */
SELECT
...
FROM espen_bj_lf_pretas_1_site_202009_v3 src
  JOIN espen_bj_lf_pretas_1_site_202009_v3 dest on (
