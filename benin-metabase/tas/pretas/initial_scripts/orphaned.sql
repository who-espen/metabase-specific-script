...
/*
 * Variable to rename metabase_lf_pretas_orphaned_202009, v_espen_bj_lf_pretas_2_participant_202009_v3,
      ...
      SELECT * FROM v_lf_orphaned_of_participants p
       ...
       WHERE p.id ISNULL
          ...
          where id_participant NOT IN (
            ...
            LEFT JOIN metabase_lf_pretas_orphaned_202009 m ON p.id = m.id_participant
  ...
  SELECT id, d_recorder_id, d_code_id, 'FTS results without participant'
    FROM (
      SELECT
        ...
        FROM v_espen_bj_lf_pretas_2_participant_202009_v3 p
         RIGHT JOIN v_espen_bj_lf_pretas_3_resultat_fts_202009_v3 d on p.p_code_id = d.d_code_id
          WHERE p.id isnull
          ) p
