 ...
 * Variable to rename espen_bj_lf_tas3_202304_1_sites, <%village_dist_required%>
 */
SELECT
...
FROM espen_bj_lf_tas3_202304_1_sites src
  JOIN espen_bj_lf_tas3_202304_1_sites dest on (
