 ...
 * Variable to rename v_espen_bf_202403_sch_ia_1_sites, <%village_dist_required%>
 */
SELECT
...
FROM v_espen_bf_202403_sch_ia_1_sites src
  JOIN v_espen_bf_202403_sch_ia_1_sites dest on (
