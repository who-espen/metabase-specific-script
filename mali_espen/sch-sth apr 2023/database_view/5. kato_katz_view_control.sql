...
CREATE OR REPLACE VIEW V_ESPEN_TG_SCH_STH_IMPACT_5_CONTROL_KATO_KATZ_202304 
	AS
	SELECT
	    k1.meta_instance_id,
	    k1.k_recorder,
	    ...
	    k1.k_sch_man_sa,
	    k1.k_sch_man_sb, (
	        k1.k_sch_man_sa + k1.k_sch_man_sb
	    ...
	    k1.k_ascaris_lumb_sb, (
	        k1.k_ascaris_lumb_sa + k1.k_ascaris_lumb_sb
	    ...
	    k1.k_hookworm_sa,
	    k1.k_hookworm_sb, (
	        k1.k_hookworm_sa + k1.k_hookworm_sb
	    ) * 12 AS k_hookworm_intensity,
	    CASE
	        WHEN ( (
	                k1.k_hookworm_sa + k1.k_hookworm_sb
	            ) * 12
	    ...
	    k1.k_trichuris_sa,
	    k1.k_trichuris_sb, (
	        k1.k_trichuris_sa + k1.k_trichuris_sb
	    ...
	    k1.updated_at
	FROM
	    espen_tg_sch_sth_impact_5_control_kato_katz_202304 k1
	UNION ALL
	SELECT
	    k2.meta_instance_id,
	    k2.k_recorder,
	    ...
	    k2.k_sch_man_sa,
	    k2.k_sch_man_sb, (
	        k2.k_sch_man_sa + k2.k_sch_man_sb
	    ) * 12 AS k_sch_man_intensity,
	    CASE
	        WHEN ( (
	                k2.k_sch_man_sa + k2.k_sch_man_sb
	    ...
	    k2.k_ascaris_lumb_sb, (
	        k2.k_ascaris_lumb_sa + k2.k_ascaris_lumb_sb
	    ) * 12 AS k_ascaris_lumb_intensity,
	    CASE
	        WHEN ( (
	                k2.k_ascaris_lumb_sa + k2.k_ascaris_lumb_sb
	    ...
	    k2.k_hookworm_sa,
	    k2.k_hookworm_sb, (
	        k2.k_hookworm_sa + k2.k_hookworm_sb
	    ) * 12 AS k_hookworm_intensity,
	    CASE
	        WHEN ( (
	                k2.k_hookworm_sa + k2.k_hookworm_sb
	    ...
	    k2.k_trichuris_sa,
	    k2.k_trichuris_sb, (
	        k2.k_trichuris_sa + k2.k_trichuris_sb
	    ) * 12 AS k_trichuris_intensity,
	    CASE
	        WHEN ( (
	                k2.k_trichuris_sa + k2.k_trichuris_sb
	    ...
	    k2.updated_at
	FROM
	    espen_tg_sch_sth_impact_5_control_kato_katz_202304_v6_2 k2
	ORDER BY
K_START; 