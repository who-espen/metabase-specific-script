 ...
 * Variable to rename metabase_ml_sch_sth_impact_202305_duplicates, v_espen_ml_sch_sth_impact_202304_2_child, v_espen_ml_sch_sth_impact_202304_3_kato_katz,
...
FROM (
        ...
        FROM
            ...
            v_espen_ml_sch_sth_impact_202304_2_child AS p
        WHERE
        ...
        FROM
            metabase_ml_sch_sth_impact_202305_duplicates AS m,
            v_espen_ml_sch_sth_impact_202304_3_kato_katz AS k
        WHERE
        ...
        FROM
            metabase_ml_sch_sth_impact_202305_duplicates AS m,
            v_espen_ml_sch_sth_impact_202304_4_hemastix_v2 AS u
        WHERE
