 ...
 * Variable to rename metabase_ml_sch_sth_impact_202305_duplicates, v_espen_ml_sch_sth_impact_202304_3_kato_katz, v_espen_ml_sch_sth_impact_202304_2_child,
...
FROM
    metabase_ml_sch_sth_impact_202305_duplicates AS m,
    v_espen_ml_sch_sth_impact_202304_3_kato_katz AS d
WHERE
    m.id IS NOT NULL
...
FROM
    metabase_ml_sch_sth_impact_202305_duplicates AS m,
    v_espen_ml_sch_sth_impact_202304_4_hemastix_v2 AS d
WHERE
    m.id IS NOT NULL
