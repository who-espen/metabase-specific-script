...
FROM
    ...
    left join public.v_espen_ml_sch_sth_impact_202304_1_school_v2_1 c on p.p_school_id = c.w_school_id
    left join public.v_espen_ml_sch_sth_impact_202304_3_kato_katz k on p.p_code_id = k.k_code_id
GROUP BY
    p_district,
    p_school_name,
    p_start,
