 ...
 * Variable to rename v_espen_ml_sch_sth_impact_202304_1_school_v2_1, v_espen_ml_sch_sth_impact_202304_2_child, v_espen_ml_sch_sth_impact_202304_3_kato_katz
 */
...
FROM
    v_espen_ml_sch_sth_impact_202304_3_kato_katz k
    LEFT JOIN v_espen_ml_sch_sth_impact_202304_1_school_v2_1 w on w.w_school_id = k.k_school_id
    LEFT JOIN v_espen_ml_sch_sth_impact_202304_2_child p on p.p_code_id = k.k_code_id
WHERE
