 ...
 * Variable to rename v_espen_ml_sch_sth_impact_202304_1_school_v2_1, <%village_dist_required%>
 */
SELECT
...
FROM v_espen_ml_sch_sth_impact_202304_1_school_v2_1 src
  JOIN v_espen_ml_sch_sth_impact_202304_1_school_v2_1 dest on (
