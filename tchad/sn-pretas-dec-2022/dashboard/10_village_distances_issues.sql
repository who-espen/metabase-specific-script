 ...
 * Variable to rename espen_td_lf_pretas_1_site_202208_v2, <%village_dist_required%>
 */
SELECT
...
FROM espen_td_lf_pretas_1_site_202208_v2 src
  JOIN espen_td_lf_pretas_1_site_202208_v2 dest on (
