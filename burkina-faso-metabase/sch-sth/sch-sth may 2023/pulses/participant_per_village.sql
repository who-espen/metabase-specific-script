 ...
 * Variable to rename v_espen_bf_202305_sch_impact_assessment_2_enrolement_v1_1, v_espen_bf_202305_sch_impact_assessment_1_sites
 */
...
FROM
    ...
    LEFT JOIN v_espen_bf_202305_sch_impact_assessment_1_sites w on w.w_school_id = p.p_school_id
