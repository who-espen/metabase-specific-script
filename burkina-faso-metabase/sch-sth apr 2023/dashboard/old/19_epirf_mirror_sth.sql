...
left join public.v_espen_bf_202301_sch_impact_assessment_1_sites_v3 w on w.w_site_name = p.p_site
left join public.v_espen_bf_202301_sch_impact_assessment_3_resultat_selles_v3 k on k.k_code_site = p.p_code_site
left join public.v_espen_bf_202301_sch_impact_assessment_4_resultat_urines_v3 u on u.u_barcodeid = p.p_code_site

where k_code_site is not null
