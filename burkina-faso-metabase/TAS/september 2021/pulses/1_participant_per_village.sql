 ...
 * Variable to rename v_espen_bf_lf_tas3_1_sites_202109, v_espen_bf_lf_tas3_2_enrolement_202109
 */
 SELECT
...
LEFT JOIN v_espen_bf_lf_tas3_2_enrolement_202109 p ON c.nb_grappe = p.nb_grappe::INT
