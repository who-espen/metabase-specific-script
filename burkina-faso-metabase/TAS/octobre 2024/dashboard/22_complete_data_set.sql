 ...
 * Variable to rename v_espen_bf_lf_tas1_202306_3_resultats_fts_v4, v_espen_bf_lf_tas1_202306_2_participant_v4, espen_bf_lf_tas3_1_sites_202307
 */
...
where
    p.nb_grappe = c.nb_grappe
    and p.barcode = d.barcode;