 ...
 * Variable to rename v_espen_bf_lf_tas3_2_participant_202209_v1_y, espen_bf_lf_tas3_1_sites_202209_y
 */
 SELECT
nb_grappe "Site ID",
c_eu_code "EU",
...
LEFT JOIN espen_bf_lf_tas3_1_sites_202209_y c on d.d_cluster_id::int = c.nb_grappe
RIGHT JOIN v_espen_bf_lf_tas3_2_participant_202209_v1_y p on p.barcode = d.barcode
