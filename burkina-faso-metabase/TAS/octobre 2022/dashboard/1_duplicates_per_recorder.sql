 ...
 * Variable to rename metabase_bf_lf_tas3_duplicates_202209_y? espen_bf_lf_tas3_3_resultat_sth_202209_y
 */
 SELECT
...
FROM (
  SELECT
    ...
    FROM public.metabase_bf_lf_tas3_duplicates_202209_y m
    JOIN v_espen_bf_lf_tas3_3_resultat_fts_202209_v1_y d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_bf_lf_tas3_duplicates_202209_y m
    JOIN espen_bf_lf_tas3_2_enrolement_202209_y p ON p.id = m.id_participant

  group by p.code_operateur, p_district, nb_grappe, nom_de_la_grappe
