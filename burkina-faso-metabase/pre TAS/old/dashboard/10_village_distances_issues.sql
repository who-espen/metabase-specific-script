 ...
 * Variable to rename espen_bf_lf_pretas_1_sites_202007, <%village_dist_required%>
 */
SELECT
...
FROM espen_bf_lf_pretas_1_sites_202007 src
  JOIN espen_bf_lf_pretas_1_sites_202007 dest on (
