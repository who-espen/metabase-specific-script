 ...
 * Variable to rename v_espen_bf_lf_pretas_2_enrollement_202007_v2, espen_bf_lf_pretas_1_sites_202007
 */
 SELECT
...
LEFT JOIN espen_bf_lf_pretas_1_sites_202007 c on d.d_cluster_id::int = c.c_cluster_id
RIGHT JOIN v_espen_bf_lf_pretas_2_enrollement_202007_v2 p on p.p_barcode_id = d.d_barcode_id
