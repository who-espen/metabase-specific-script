 ...
 * Variable to rename v_espen_bf_lf_pretas_1_sites_202007, v_espen_bf_lf_pretas_2_enrollement_202007_v2
 */
 SELECT
...
FROM v_espen_bf_lf_pretas_1_sites_202007 c
LEFT JOIN v_espen_bf_lf_pretas_2_enrollement_202007_v2 p ON c.c_cluster_id = p.p_cluster_id::INT
