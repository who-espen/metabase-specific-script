 ...
 * Variable to rename v_espen_bf_lf_pretas_1_sites_202106_v2, v_espen_bf_lf_pretas_2_enrolement_202106_v2_2
 */
 SELECT
...
LEFT JOIN v_espen_bf_lf_pretas_2_enrolement_202106_v2_2 p ON c.c_cluster_id1 = p.p_cluster_id::INT
