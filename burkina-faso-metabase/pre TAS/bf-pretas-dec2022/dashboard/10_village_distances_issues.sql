 ...
 * Variable to rename espen_bf_lf_pretas_1_village_202212_v2, <%village_dist_required%>
 */
SELECT
...
FROM v_espen_bf_lf_pretas_1_village_202212_v2 src
  JOIN v_espen_bf_lf_pretas_1_village_202212_v2 dest on (
