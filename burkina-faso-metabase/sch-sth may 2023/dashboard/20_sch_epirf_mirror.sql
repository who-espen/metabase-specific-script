...
from
    ...
    left join v_espen_bf_202305_sch_impact_assessment_1_sites c on c.c_code_site = p.p_code_site
    and c.c_district = p.p_district
    left join v_espen_bf_202305_sch_impact_assessment_3_resultat_selles_full k on p.p_numero_enquete_complet = k.d_numero_enquete_complet
    left join v_espen_bf_202305_sch_impact_assessment_4_resultat_urines_v1_1 u on p.p_numero_enquete_complet = u.u_numero_enquete_complet
group by
    c_drshp,
    c_district,
    c_ecole,
