 ...
 * Variable to rename espen_sn_lf_pretas_1_sites_202107_v2, v_espen_sn_lf_pretas_2_partcipants_202107_v2
 */
SELECT
...
JOIN v_espen_sn_lf_pretas_2_partcipants_202107_v2 p ON p.p_cluster_id = c.c_cluster_id

WHERE c.id IS NOT NULL

GROUP BY c_recorder, c_cluster_id, c_district, c_population, c_cluster_name