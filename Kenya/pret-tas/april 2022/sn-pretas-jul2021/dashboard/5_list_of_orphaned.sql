 ...
 * Variable to rename v_espen_sn_lf_pretas_2_partcipants_202107_v2, v_espen_bj_lf_pretas_3_fts_result_202107_v2, metabase_lf_pretas_orphaned_202108
 */
    ...
    FROM v_espen_sn_lf_pretas_2_partcipants_202107_v2 p
      ...
      LEFT JOIN metabase_lf_pretas_orphaned_202108 m on m.id_participant = p.id
      WHERE d.id isNULL
    ...
    FROM v_espen_bj_lf_pretas_3_fts_result_202107_v2 d
      LEFT JOIN v_espen_sn_lf_pretas_2_partcipants_202107_v2 p on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_lf_pretas_orphaned_202108 m on m.id_results = d.id
      WHERE p.id isNULL
