...
SELECT src.id, src.p_barcode_id FROM v_espen_ke_lf_tas1_2_participant_202206_v2 src
                WHERE (SELECT count (*)  FROM v_espen_ke_lf_tas1_2_participant_202206_v2 inr WHERE src.p_barcode_id = inr.p_barcode_id ) > 1;
...
SELECT src.id, src.d_barcode_id FROM v_espen_ke_lf_tas1_3_resultat_fts_202206_v2 src
                WHERE (SELECT count (*)  FROM v_espen_ke_lf_tas1_3_resultat_fts_202206_v2 inr WHERE src.d_barcode_id = inr.d_barcode_id ) > 1;
