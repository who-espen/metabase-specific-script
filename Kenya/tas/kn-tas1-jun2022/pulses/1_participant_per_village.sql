 ...
 * Variable to rename v_espen_ke_lf_tas1_1_site_202206_v2, v_espen_ke_lf_tas1_2_participant_202206_v2
 */
 SELECT
...
LEFT JOIN v_espen_ke_lf_tas1_2_participant_202206_v2 p ON c.c_cluster_id = p.p_cluster_id::INT

where p.p_start > CURRENT_start - 1

GROUP BY p_enumerator, c_district, c_cluster_id, c_cluster_name
