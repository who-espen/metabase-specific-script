...
/*
 * Variable to rename metabase_oncho_oem_gn_202310_duplicates, espen_gn_oncho_oem_202310_2_participant_v2, espen_gn_oncho_oem_3_resultat_ov16_202206_v3,
 * v_espen_gn_oncho_oem_202310_2_participant_v2, <%v_ab_cde_fgh_3_dbs%>, <%metabase_oncho_oem_duplicates_202004_trigger%>,
...
*/ 
INSERT INTO metabase_oncho_oem_gn_202310_duplicates(
...
1) P ON CONFLICT ON CONSTRAINT UNIQUE_idx_duplicates_participant_id_barcode_oncho_oem_gn_202310 
DO NOTHING; COMMIT; 
/*******************************************************************************************************************************************
