 ...
 * Variable to rename <%ab_cde_fgh_3_rdt_ov16%>, v_espen_gn_oncho_oem_202310_2_participant_v2
 */
...
FROM
    v_espen_gn_oncho_oem_202310_1_site_v3 p
    LEFT JOIN v_espen_gn_oncho_oem_202310_2_participant_v2 c ON c.c_cluster_name_id = p.p_cluster_name_id:: INT
where
