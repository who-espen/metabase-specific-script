 ...
 * Variable to rename espen_gn_oncho_oem_202310_1_site_v3, <%village_dist_required%>
 */
SELECT
...
FROM public.v_espen_gn_oncho_oem_202310_1_site_v3 src
  JOIN public.v_espen_gn_oncho_oem_202310_1_site_v3 dest on (
