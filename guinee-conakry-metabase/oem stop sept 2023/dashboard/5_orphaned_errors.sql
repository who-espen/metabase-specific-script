 ...
 * Variable to rename v_espen_gn_oncho_oem_202310_2_participant_v2, <%v_ab_cde_fgh_3_rdt_ov16%>, <%metabase_oncho_oem_orphaned_202004%>
 */
...
FROM
    ...
    LEFT JOIN v_espen_gn_oncho_oem_202310_2_participant_v2 p on p.p_barcode_id1 = d.r_barcode_id1
