...
FROM (
  SELECT
    ...
    FROM public.metabase_lf_tas1_duplicates_202104 m
    JOIN espen_sn_lf_tas1_3_fts_result_202104_v2 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_lf_tas1_duplicates_202104 m
    JOIN espen_sn_lf_tas1_2_partcipants_202104_v2 p ON p.id = m.id_participant
