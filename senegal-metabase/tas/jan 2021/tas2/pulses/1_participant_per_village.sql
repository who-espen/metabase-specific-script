 ...
 * Variable to rename v_espen_sn_lf_tas2_1_sites_202101, v_espen_sn_lf_tas2_2_partcipants_202101
 */
 SELECT
...
LEFT JOIN v_espen_sn_lf_tas2_2_partcipants_202101 p ON c.c_cluster_id = p.p_cluster_id::INT
