 ...
 * Variable to rename espen_sn_lf_tas_1_sites_202101_v3, <%village_dist_required%>
 */
SELECT
...
FROM espen_sn_lf_tas_1_sites_202101_v3 src
  JOIN espen_sn_lf_tas_1_sites_202101_v3 dest on (
