 ...
 * Variable to rename v_espen_sn_lf_tas3_20305_1_site, v_espen_sn_lf_tas3_20305_2_partcipants
 */
...
FROM
    v_espen_sn_lf_tas3_20305_1_site c
    LEFT JOIN v_espen_sn_lf_tas3_20305_2_partcipants p ON c.c_cluster_id = p.p_cluster_id:: INT
where
