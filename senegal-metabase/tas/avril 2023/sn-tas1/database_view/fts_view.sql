...
/*
 * Variable to rename  v_espen_sn_lf_tas1_3_fts_result_202104_v2, espen_sn_lf_tas1_3_fts_result_202104_v2, espen_sn_lf_tas1_1_sites_202104_v2
 */
CREATE view v_espen_sn_lf_tas1_3_fts_result_202104_v2
AS
SELECT
  id,
  d_recorder_id,
  ...
  CASE WHEN d_id_type = 'Scanner' THEN d_generate_id ELSE d_generate_id END AS d_generate_id,
...
FROM public.espen_sn_lf_tas1_3_fts_result_202104_v2 d
