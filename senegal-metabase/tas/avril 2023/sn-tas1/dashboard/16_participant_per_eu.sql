 ...
 * Variable to rename v_espen_sn_lf_tas3_20305_2_partcipants, v_espen_sn_lf_tas3_20305_1_site
 */
...
FROM
    ...
    LEFT JOIN v_espen_sn_lf_tas3_20305_1_site c ON p.p_cluster_id:: INT = c.c_cluster_id1
WHERE
