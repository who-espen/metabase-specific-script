 ...
 * Variable to rename espen_sn_lf_tas1_1_sites_202202_2, <%village_dist_required%>
 */
SELECT
...
FROM espen_sn_lf_tas1_1_sites_202202_2 src
  JOIN espen_sn_lf_tas1_1_sites_202202_2 dest on (
