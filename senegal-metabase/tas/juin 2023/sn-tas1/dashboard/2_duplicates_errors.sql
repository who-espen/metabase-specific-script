 ...
 * Variable to rename metabase_lf_tas1_duplicates_202104, v_espen_sn_lf_tas2_20306_2_partcipants, v_espen_sn_lf_tas2_20306_3_fts_result
 */
...
FROM (
        SELECT
            ...
            status "Statut"
        FROM
            metabase_lf_tas1_duplicates_202104 AS m,
            v_espen_sn_lf_tas2_20306_2_partcipants AS p
        WHERE
        ...
        FROM
            metabase_lf_tas1_duplicates_202104 AS m,
            v_espen_sn_lf_tas2_20306_3_fts_result AS d
        WHERE
            d.id = m.id_results
    ) src
WHERE "Formulaire" IS NOT NULL ------ Metabase filter -------