 ...
 * Variable to rename v_espen_sn_lf_tas2_20306_2_partcipants, v_espen_sn_lf_tas2_20306_3_fts_result
 */
...
FROM
    ...
    LEFT JOIN v_espen_sn_lf_tas2_20306_3_fts_result d on d.d_barcode_id = p.p_barcode_id
