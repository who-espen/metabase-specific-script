 ...
 * Variable to rename v_espen_sn_lf_tas2_20306_1_site, <%village_dist_required%>
 */
...
FROM
    v_espen_sn_lf_tas2_20306_1_site src
    JOIN v_espen_sn_lf_tas2_20306_1_site dest on (
        SELECT
            calculate_distance(
                src.c_gps_lat,
                src.c_gps_lng,
