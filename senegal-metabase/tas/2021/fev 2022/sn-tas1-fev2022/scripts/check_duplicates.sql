...
CREATE TABLE IF NOT EXISTS metabase_lf_tas1_duplicates_202202(
...
*/
  CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_participant_id_barcode_202202
    ON metabase_lf_tas1_duplicates_202202(id_participant, barcode_participant);
  CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_results_id_barcode_202202
    ON metabase_lf_tas1_duplicates_202202(id_results, barcode_results);

  ALTER TABLE metabase_lf_tas1_duplicates_202202
    ADD CONSTRAINT unique_idx_duplicates_participant_id_barcode_202202
    UNIQUE USING INDEX idx_duplicates_participant_id_barcode_202202;

  ALTER TABLE metabase_lf_tas1_duplicates_202202
    ADD CONSTRAINT unique_idx_duplicates_results_id_barcode_202202
    UNIQUE USING INDEX idx_duplicates_results_id_barcode_202202;
