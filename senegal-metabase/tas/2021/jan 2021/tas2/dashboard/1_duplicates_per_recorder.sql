 ...
 * Variable to rename metabase_lf_pretas_duplicates_202101_tas2? espen_sn_lf_tas2_3_fts_result_202101
 */
 SELECT
...
FROM (
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202101_tas2 m
    JOIN espen_sn_lf_tas2_3_fts_result_202101 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202101_tas2 m
    JOIN espen_sn_lf_tas2_2_partcipants_202101 p ON p.id = m.id_participant
