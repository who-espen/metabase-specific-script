 ...
 * Variable to rename metabase_lf_pretas_duplicates_202101_tas1? espen_sn_lf_tas_3_fts_result_202101_v3
 */
 SELECT
...
FROM (
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202101_tas1 m
    JOIN espen_sn_lf_tas_3_fts_result_202101_v3 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202101_tas1 m
    JOIN espen_sn_lf_tas_2_partcipants_202101_v3 p ON p.id = m.id_participant
