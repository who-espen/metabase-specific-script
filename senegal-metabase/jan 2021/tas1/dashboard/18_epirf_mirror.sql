 ...
 * Variable to rename <%Epirf_Survey_Type%>, v_espen_sn_lf_tas_3_fts_result_202101_v3, v_espen_sn_lf_tas_2_partcipants_202101_v3,
...
LEFT JOIN v_espen_sn_lf_tas_1_sites_202101_v3 c on d.d_cluster_id = c.c_cluster_id
RIGHT JOIN v_espen_sn_lf_tas_2_partcipants_202101_v3 p on p.p_barcode_id = d.d_barcode_id

GROUP BY c_eu_name, c_commune, c_cluster_name, "Month", "Year", c_gps_lat, c_gps_lng

order by c_eu_name, c_commune
