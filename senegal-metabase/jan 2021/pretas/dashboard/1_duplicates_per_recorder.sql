 ...
 * Variable to rename metabase_lf_pretas_duplicates_202009? espen_bj_lf_pretas_3_fts_result_202009
 */
 SELECT
...
FROM (
  SELECT
    ...
    JOIN espen_bj_lf_pretas_3_fts_result_202009 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202009 m
    JOIN espen_sn_lf_pretas_2_partcipants_202009_manual p ON p.id = m.id_participant
