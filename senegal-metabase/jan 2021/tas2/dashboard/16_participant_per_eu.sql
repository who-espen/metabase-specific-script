 ...
 * Variable to rename v_espen_sn_lf_tas2_2_partcipants_202101, espen_sn_lf_tas2_1_sites_202101
 */
 SELECT
...
LEFT JOIN espen_sn_lf_tas2_1_sites_202101 c ON p.p_cluster_id::INT = c.c_cluster_id1
