 ...
 * Variable to rename espen_sn_lf_tas2_1_sites_202101, <%village_dist_required%>
 */
SELECT
...
FROM espen_sn_lf_tas2_1_sites_202101 src
  JOIN espen_sn_lf_tas2_1_sites_202101 dest on (
