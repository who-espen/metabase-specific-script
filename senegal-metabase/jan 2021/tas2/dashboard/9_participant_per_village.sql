 ...
 * Variable to rename espen_sn_lf_tas2_1_sites_202101, v_espen_sn_lf_tas2_2_partcipants_202101
 */
SELECT
...
FROM espen_sn_lf_tas2_1_sites_202101 c
JOIN v_espen_sn_lf_tas2_2_partcipants_202101 p ON p.p_cluster_id::INT = c.c_cluster_id
