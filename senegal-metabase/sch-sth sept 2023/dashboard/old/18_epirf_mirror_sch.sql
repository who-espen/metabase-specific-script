...
FROM
    ...
    left join public.v_espen_sn_sch_sth_impact_3_resultats_202308_v3_full k on p.p_barcodeid = k.r_barcodeid
    left join public.v_espen_bj_sch_sth_impact_202304_4_urine_filtration_v1_full u on p.p_barcodeid = u.u_espen_code_id
