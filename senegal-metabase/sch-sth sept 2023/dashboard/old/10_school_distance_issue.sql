 ...
 * Variable to rename v_espen_sn_sch_sth_impact_1_school_202308_v3_1, <%village_dist_required%>
 */
...
FROM
    v_espen_sn_sch_sth_impact_1_school_202308_v3_1 src
    JOIN v_espen_sn_sch_sth_impact_1_school_202308_v3_1 dest on (
        SELECT
            calculate_distance(
                src.w_gps_lat,
                src.w_gps_lng,
