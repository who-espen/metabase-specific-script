...
FROM
    public.v_espen_sn_sch_sth_impact_2_child_202308_v3_2 p

left join public.v_espen_sn_sch_sth_impact_1_school_202308_v3_1 w on w.w_site_name = p.p_site
left join public.v_espen_sn_sch_sth_impact_3_resultats_202308_v3 k on k.r_barcodeid = p.p_barcodeid
left join public.v_espen_bj_sch_sth_impact_202304_4_urine_filtration_v1 u on u.u_barcodeid = p.p_barcodeid

where r_barcodeid is not null 
