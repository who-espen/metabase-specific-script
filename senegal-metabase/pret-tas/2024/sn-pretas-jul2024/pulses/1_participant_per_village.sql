 ...
 * Variable to rename v_espen_sn_lf_pretas_20407_2_fts_v3, v_espen_sn_lf_pretas_20407_2_fts_v3
 */
...
FROM
    ...
    LEFT JOIN v_espen_sn_lf_pretas_20407_2_fts_v3 p ON c.c_cluster_id = p.p_cluster_id:: INT
where
