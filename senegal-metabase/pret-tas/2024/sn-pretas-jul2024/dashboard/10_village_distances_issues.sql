 ...
 * Variable to rename espen_sn_lf_pretas_1_sites_202307, <%village_dist_required%>
 */
...
FROM
    espen_sn_lf_pretas_1_sites_202307 src
    JOIN espen_sn_lf_pretas_1_sites_202307 dest on (
        SELECT
            calculate_distance(
                src.c_gps_lat,
                src.c_gps_lng,
