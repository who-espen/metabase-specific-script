 ...
 * Variable to rename v_espen_sn_lf_pretas_1_sites_202207_v1, v_espen_sn_lf_pretas_2_partcipants_202207_v1
 */
 SELECT
...
LEFT JOIN v_espen_sn_lf_pretas_2_partcipants_202207_v1 p ON c.c_cluster_id = p.p_cluster_id::INT
