 ...
 * Variable to rename espen_sn_lf_pretas_1_sites_202207_v1, v_espen_sn_lf_pretas_2_partcipants_202207_v1
 */
SELECT
...
JOIN v_espen_sn_lf_pretas_2_partcipants_202207_v1 p ON p.p_cluster_id = c.c_cluster_id
