 ...
 * Variable to rename v_espen_sn_lf_pretas_2_partcipants_202207_v1, espen_sn_lf_pretas_1_sites_202207_v1
 */
 SELECT
...
LEFT JOIN espen_sn_lf_pretas_1_sites_202207_v1 c ON p.p_cluster_id::INT = c.c_cluster_id1
