 ...
 * Variable to rename metabase_sn_lf_pretas_duplicates_202207? espen_sn_lf_pretas_3_fts_result_202207_v1
 */
  SELECT
...
FROM (
  SELECT
    ...
    FROM public.metabase_sn_lf_pretas_duplicates_202207 m
    JOIN v_espen_sn_lf_pretas_3_fts_result_202207_v1 d ON d.id = m.id_results
  ...
  SELECT
   ...
   p_cluster_id cluster_id,
    ...
    FROM public.metabase_sn_lf_pretas_duplicates_202207 m
    JOIN v_espen_sn_lf_pretas_2_partcipants_202207_v1 p ON p.id = m.id_participant::int
