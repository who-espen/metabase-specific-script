 ...
 * Variable to rename espen_sn_lf_pretas_1_sites_202207_v1, <%village_dist_required%>
 */
SELECT
...
FROM espen_sn_lf_pretas_1_sites_202207_v1 src
  JOIN espen_sn_lf_pretas_1_sites_202207_v1 dest on (
