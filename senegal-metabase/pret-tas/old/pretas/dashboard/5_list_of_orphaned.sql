 ...
 * Variable to rename v_espen_sn_lf_tas1_2_partcipants_202009_manual, v_espen_bj_lf_tas1_3_fts_result_202009, metabase_lf_tas1_orphaned_202009
 */
    ...
    FROM v_espen_sn_lf_tas1_2_partcipants_202009_manual p
      ...
      LEFT JOIN metabase_lf_tas1_orphaned_202009 m on m.id_participant = p.id
      WHERE d.id isNULL
  ...
  -- [[and {{date}}]]
    ...
    FROM v_espen_bj_lf_tas1_3_fts_result_202009 d
      LEFT JOIN v_espen_sn_lf_tas1_2_partcipants_202009_manual p on p.p_generate_id = d.d_generate_id
      LEFT JOIN metabase_lf_tas1_orphaned_202009 m on m.id_results = d.id
      WHERE p.id isNULL
