 ...
 * Variable to rename v_espen_sn_lf_pretas_2_partcipants_202009_manual, v_espen_bj_lf_pretas_3_fts_result_202009
 */
 SELECT
...
FROM v_espen_sn_lf_pretas_2_partcipants_202009_manual p
  LEFT JOIN v_espen_bj_lf_pretas_3_fts_result_202009 d on d.d_barcode_id = p.p_barcode_id
