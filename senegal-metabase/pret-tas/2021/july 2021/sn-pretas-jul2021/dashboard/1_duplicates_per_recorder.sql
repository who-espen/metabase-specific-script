 ...
 * Variable to rename metabase_lf_pretas_duplicates_202108? espen_bj_lf_pretas_3_fts_result_202107_v2
 */
  SELECT
...
FROM (
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202108 m
    JOIN espen_bj_lf_pretas_3_fts_result_202107_v2 d ON d.id = m.id_results
  ...
  SELECT
   ...
   p_cluster_id cluster_id,
    ...
    FROM public.metabase_lf_pretas_duplicates_202108 m
    JOIN espen_sn_lf_pretas_2_partcipants_202107_v2 p ON p.id = m.id_participant::int
