 ...
 * Variable to rename espen_sn_lf_pretas_1_sites_202009, <%village_dist_required%>
 */
SELECT
...
FROM espen_sn_lf_pretas_1_sites_202009 src
  JOIN espen_sn_lf_pretas_1_sites_202009 dest on (
