 ...
 * Variable to rename <%Epirf_Survey_Type%>, v_espen_bj_lf_pretas_3_fts_result_202009, v_espen_sn_lf_pretas_2_partcipants_202009_manual,
...
LEFT JOIN v_espen_sn_lf_pretas_1_sites_202009 c on d.d_cluster_id = c.c_cluster_id
