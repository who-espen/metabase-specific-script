 ...
 * Variable to rename v_espen_sn_lf_pretas_1_sites_202307, v_espen_sn_lf_pretas_2_partcipants_202307_v1_3
 */
...
FROM
    ...
    LEFT JOIN v_espen_sn_lf_pretas_2_partcipants_202307_v1_3 p ON c.c_cluster_id = p.p_cluster_id:: INT
where
