 ...
 * Variable to rename metabase_sppa_mapping_duplicates_2511, v_espen_bj_sch_sth_impact_202304_3_kato_katz_v1, v_espen_bj_sch_sth_impact_202304_4_urine_filtration_v1
 */
 SELECT
...
FROM (
  SELECT
    ...
    FROM public.metabase_sppa_mapping_duplicates_2511 m
