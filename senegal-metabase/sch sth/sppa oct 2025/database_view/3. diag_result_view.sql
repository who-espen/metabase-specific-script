CREATE OR REPLACE VIEW public.v_espen_sn_sppa_impact_2510_3_resultat_v3
AS SELECT c.id,
    p.r_recorder,
    p.r_region,
    p.r_district,
    ...
    c.r_remarks,
    p.r_start
   FROM espen_sn_sppa_impact_2510_3_resultat_v3 p,
    espen_sn_sppa_impact_2510_3_resultat_v3_r_sppa_2505_3_1 c
