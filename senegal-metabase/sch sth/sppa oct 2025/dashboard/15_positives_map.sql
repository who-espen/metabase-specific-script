...
FROM public.v_espen_bf_202403_sch_ia_1_sites w
...
d_oeufs_ank_a > 0 OR d_oeufs_ank_b > 0 OR d_oeufs_trichuris_a > 0 OR d_oeufs_trichuris_b > 0) or (u_urine_intensite > 0)