 ...
 * Variable to rename v_espen_sn_lf_tas1_2_partcipants_202105, v_espen_sn_lf_tas1_3_fts_result_202105
 */
 SELECT
...
FROM v_espen_sn_lf_tas1_2_partcipants_202105 p
  LEFT JOIN v_espen_sn_lf_tas1_3_fts_result_202105 d on d.d_generate_id = p.p_generate_id
