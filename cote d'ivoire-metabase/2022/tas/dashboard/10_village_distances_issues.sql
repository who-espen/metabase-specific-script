 ...
 * Variable to rename espen_ci_lf_tas1_1_sites_202110_v3, <%village_dist_required%>
 */
SELECT
...
FROM espen_ci_lf_tas1_1_sites_202110_v3 src
  JOIN espen_ci_lf_tas1_1_sites_202110_v3 dest on (
