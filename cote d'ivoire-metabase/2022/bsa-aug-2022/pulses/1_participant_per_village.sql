 ...
 * Variable to rename v_espen_tg_oncho_stop_1_site_202209, v_espen_tg_oncho_stop_2_participants_202209
 */
 SELECT
...
FROM v_espen_tg_oncho_stop_1_site_202209 c
LEFT JOIN v_espen_tg_oncho_stop_2_participants_202209 p ON c.c_cluster_id = p.p_cluster_id::INT
