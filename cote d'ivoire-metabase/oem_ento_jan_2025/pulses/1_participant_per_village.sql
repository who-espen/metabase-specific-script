 ...
 * Variable to rename <%ab_cde_fgh_3_rdt_ov16%>, v_espen_bj_oncho_stop_2_202306_questions_v3
 */
...
FROM
    v_espen_bj_oncho_stop_1_202306_site_v3 p
    LEFT JOIN v_espen_bj_oncho_stop_2_202306_questions_v3 c ON c.c_cluster_id = p.p_cluster_id:: INT
where
