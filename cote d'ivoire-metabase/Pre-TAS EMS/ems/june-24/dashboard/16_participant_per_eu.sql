 ...
 * Variable to rename v_espen_ci_lf_pretas_2406_3_part_v4, espen_ci_lf_pretas_2406_1_site_v4
 */
 SELECT
...
LEFT JOIN espen_ci_lf_pretas_2406_1_site_v4 c ON p.p_site_id::INT = c.c_site_id1
