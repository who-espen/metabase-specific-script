...
CREATE UNIQUE INDEX IF NOT EXISTS idx_orphaned_results_fts_id_barcode_ci_lf_ems_2406 ON metabase_ci_lf_2406_ems_orphaned
...
ALTER TABLE metabase_ci_lf_2406_ems_orphaned
  ADD CONSTRAINT unique_idx_orphaned_results_fts_id_barcode_ci_lf_ems_2406
  UNIQUE USING INDEX idx_orphaned_results_fts_id_barcode_ci_lf_ems_2406;
...
CREATE TRIGGER metabase_ci_lf_on_ems_orph_part_w_fts_2406_trigger AFTER INSERT OR UPDATE OR DELETE ON espen_ci_lf_pretas_2406_1_site_v4
...
() RETURNS TRIGGER LANGUAGE PLPGSQL AS
	...
	FROM (
	        ...
	        WHERE
	            p.id isnull
	    ) p ON CONFLICT ON CONSTRAINT unique_idx_orphaned_results_fts_id_barcode_ci_lf_ems_2406
	DO NOTHING;
	--  COMMIT;
...
CREATE TRIGGER metabase_ci_lf_on_ems_orph_fts_w_part_2024_trigger AFTER INSERT OR UPDATE OR DELETE ON espen_ci_lf_pretas_2406_1_site_v4
