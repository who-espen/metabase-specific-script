 ...
 * Variable to rename v_espen_ci_lf_pretas_2_participant_202302, v_espen_ci_lf_pretas_3_resultat_fts_202302
 */
 SELECT
...
FROM v_espen_ci_lf_pretas_2_participant_202302 p
  LEFT JOIN v_espen_ci_lf_pretas_3_resultat_fts_202302 d on d.d_code_id = p.p_code_id
