 ...
 * Variable to rename v_espen_ci_lf_pretas_2_participant_202302, v_espen_ci_lf_pretas_3_resultat_fts_202302, metabase_ci_lf_pretas_202302_orphaned
 */
  ...
  -- [[and {{date}}]]
    ...
    FROM v_espen_ci_lf_pretas_3_resultat_fts_202302 d
      LEFT JOIN v_espen_ci_lf_pretas_2_participant_202302 p on p.p_code_id = d.d_code_id
