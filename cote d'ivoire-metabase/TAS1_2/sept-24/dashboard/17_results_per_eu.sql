 ...
 * Variable to rename v_espen_ci_lf_tas1_2409_2_partcipants, espen_ci_lf_tas1_2409_1_sites
 */
 SELECT
...
COUNT(CASE WHEN (p_sex = 'Male' and d_final_result = 'Positif') THEN 1 ELSE NULL END) "Positif Male",
COUNT(CASE WHEN (p_sex = 'Female' and d_final_result = 'Positif') THEN 1 ELSE NULL END) "Positif Female",
COUNT(CASE WHEN (d_final_result = 'Positif') THEN 1 ELSE NULL END) "Total Positif",
