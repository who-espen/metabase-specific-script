 ...
 * Variable to rename espen_ci_lf_tas1_2409_1_sites, <%village_dist_required%>
 */
SELECT
...
FROM espen_ci_lf_tas1_2409_1_sites src
  JOIN espen_ci_lf_tas1_2409_1_sites dest on (
