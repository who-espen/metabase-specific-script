 ...
 * Variable to rename metabase_ci_lf_tas1_202302_duplicates? espen_ci_202302_lf_tas1_3_fts_result
 */
...
FROM (
  SELECT
    ...
    FROM public.metabase_ci_lf_tas1_202302_duplicates m
    JOIN v_espen_ci_202302_lf_tas1_3_fts_result d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_ci_lf_tas1_202302_duplicates m
    JOIN v_espen_ci_202302_lf_tas1_2_partcipants p ON p.id = m.id_participant
