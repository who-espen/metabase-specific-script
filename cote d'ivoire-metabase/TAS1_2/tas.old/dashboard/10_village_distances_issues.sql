 ...
 * Variable to rename espen_ci_202302_lf_tas1_1_sites, <%village_dist_required%>
 */
SELECT
...
FROM espen_ci_202302_lf_tas1_1_sites src
  JOIN espen_ci_202302_lf_tas1_1_sites dest on (
