 ...
 * Variable to rename v_espen_ci_202302_lf_tas1_2_partcipants, v_espen_ci_202302_lf_tas1_3_fts_result
 */
...
FROM v_espen_ci_202302_lf_tas1_2_partcipants p
  LEFT JOIN v_espen_ci_202302_lf_tas1_3_fts_result d on d.d_code_id = p.p_code_id
