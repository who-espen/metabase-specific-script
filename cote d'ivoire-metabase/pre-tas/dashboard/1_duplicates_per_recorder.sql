 ...
 * Variable to rename metabase_lf_pretas_duplicates_202204? espen_ci_lf_pretas_3_resultat_fts_202204_v1
 */
 SELECT
...
FROM (
  SELECT
    ...
    JOIN v_espen_ci_lf_pretas_3_resultat_fts_202204_v1 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202204 m
    JOIN v_espen_ci_lf_pretas_2_participant_202204_v1 p ON p.id = m.id_participant
