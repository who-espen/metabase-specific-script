 ...
 * Variable to rename espen_ci_lf_pretas_1_site_202204, v_espen_ci_lf_pretas_2_participant_202204_v1
 */
SELECT
...
FROM v_espen_ci_lf_pretas_1_site_202204 c
JOIN v_espen_ci_lf_pretas_2_participant_202204_v1 p ON p.p_site_id = c.c_site_id
