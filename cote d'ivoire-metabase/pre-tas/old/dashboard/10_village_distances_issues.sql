 ...
 * Variable to rename espen_ci_lf_pretas_1_site_202302, <%village_dist_required%>
 */
SELECT
...
FROM espen_ci_lf_pretas_1_site_202302 src
  JOIN espen_ci_lf_pretas_1_site_202302 dest on (
