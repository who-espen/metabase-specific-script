 ...
 * Variable to rename espen_ci_lf_pretas_2406_1_site_v4, <%village_dist_required%>
 */
SELECT
...
FROM espen_ci_lf_pretas_2406_1_site_v4 src
  JOIN espen_ci_lf_pretas_2406_1_site_v4 dest on (
