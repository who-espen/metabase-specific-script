 ...
 * Variable to rename espen_ci_lf_pretas_2406_1_site_v4, v_espen_ci_lf_pretas_2406_3_part_v4
 */
SELECT
...
JOIN v_espen_ci_lf_pretas_2406_3_part_v4 p ON p.p_site_id = c.c_site_id
