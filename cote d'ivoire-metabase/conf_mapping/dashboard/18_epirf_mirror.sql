 ...
 * Variable to rename <%Epirf_Survey_Type%>, v_espen_ci_202302_lf_conf_3_fts_result, v_espen_ci_202302_lf_conf_2_partcipants_v1,
 * espen_ci_202302_lf_conf_1_sites
 */
  SELECT

  'TAS1' "Type d'enquête",
  INITCAP(c_region_name) "Unité d'Evaluation",
...
FROM v_espen_ci_202302_lf_conf_3_fts_result d
LEFT JOIN v_espen_ci_202302_lf_conf_1_sites c on d.d_cluster_id = c.c_cluster_id
RIGHT JOIN v_espen_ci_202302_lf_conf_2_partcipants_v1 p on p.p_code_id = d.d_code_id

GROUP BY c_region_name, c_commune, c_cluster_name, "Mois", "Années", c_gps_lat, c_gps_lng

order by c_region_name, c_commune, c_cluster_name
...
GROUP BY c_region_name,  "Mois", "Années"

order by c_region_name 
