...
CREATE TABLE IF NOT EXISTS metabase_ci_lf_conf_202302_duplicates(
...
*/
  CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_participant_id_barcode_202302_lf_conf
    ON metabase_ci_lf_conf_202302_duplicates(id_participant, barcode_participant);
  CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_results_id_barcode_202302_lf_conf
    ON metabase_ci_lf_conf_202302_duplicates(id_results, barcode_results);

  ALTER TABLE metabase_ci_lf_conf_202302_duplicates
    ADD CONSTRAINT unique_idx_duplicates_participant_id_barcode_202302_lf_conf
    UNIQUE USING INDEX idx_duplicates_participant_id_barcode_202302_lf_conf;

  ALTER TABLE metabase_ci_lf_conf_202302_duplicates
    ADD CONSTRAINT unique_idx_duplicates_results_id_barcode_202302_lf_conf
    UNIQUE USING INDEX idx_duplicates_results_id_barcode_202302_lf_conf;
