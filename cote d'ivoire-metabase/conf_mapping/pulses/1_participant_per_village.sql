 ...
 * Variable to rename v_espen_ci_202302_lf_conf_1_sites, v_espen_ci_202302_lf_conf_2_partcipants_v1
 */
 SELECT
...
LEFT JOIN v_espen_ci_202302_lf_conf_2_partcipants_v1 p ON c.c_cluster_id = p.p_cluster_id::INT
