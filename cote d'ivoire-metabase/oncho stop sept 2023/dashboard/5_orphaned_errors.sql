 ...
 * Variable to rename v_espen_civ_oncho_ia_202309_2_participant_v4, <%v_ab_cde_fgh_3_rdt_ov16%>, <%metabase_oncho_oem_orphaned_202004%>
 */
...
FROM
    ...
    LEFT JOIN v_espen_civ_oncho_ia_202309_2_participant_v4 p on p.p_code_id = d.d_code_id
