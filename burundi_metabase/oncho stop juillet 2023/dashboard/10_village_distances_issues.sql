 ...
 * Variable to rename espen_bi_oncho_prestop_1_202307_site_v3, <%village_dist_required%>
 */
...
FROM
    espen_bi_oncho_prestop_1_202307_site_v3 src
    JOIN espen_bi_oncho_prestop_1_202307_site_v3 dest on (
        SELECT
            calculate_distance(
                src.c_gps_lat,
                src.c_gps_lng,
