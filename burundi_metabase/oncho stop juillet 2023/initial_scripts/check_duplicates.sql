CREATE TABLE
    IF NOT EXISTS metabase_oncho_prestop_202307_duplicates(
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_participant_id_barcode_202307 ON metabase_oncho_prestop_202307_duplicates(
    id_participant,
    barcode_participant
);

CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_results_id_barcode_202307 ON metabase_oncho_prestop_202307_duplicates(id_results, barcode_results);
...
CREATE OR REPLACE FUNCTION UPDATE_ONCHO_PRESTOP_202307_DUPLICATES_TABLE_FROM_PARTICIPANT
() RETURNS VOID 
