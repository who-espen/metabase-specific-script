...
CREATE TABLE IF NOT EXISTS metabase_oncho_stop_duplicates_202204(
...
*/
  CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_participant_id_barcode_202204
    ON metabase_oncho_stop_duplicates_202204(id_participant, barcode_participant);
  CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_results_id_barcode_202204
    ON metabase_oncho_stop_duplicates_202204(id_results, barcode_results);

  ALTER TABLE metabase_oncho_stop_duplicates_202204
