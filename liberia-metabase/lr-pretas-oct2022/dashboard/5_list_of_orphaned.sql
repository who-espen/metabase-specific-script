 ...
 * Variable to rename v_espen_lr_lf_pretas_2_participant_202210, v_espen_lr_lf_pretas_3_resultat_fts_202210, metabase_lr_lf_pre_orphaned_202210
 */
    ...
    FROM v_espen_lr_lf_pretas_2_participant_202210 p
      ...
      LEFT JOIN metabase_lr_lf_pre_orphaned_202210 m on m.id_participant = p.id
      WHERE d.id isNULL
    ...
    FROM v_espen_lr_lf_pretas_3_resultat_fts_202210 d
      LEFT JOIN v_espen_lr_lf_pretas_2_participant_202210 p on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_lr_lf_pre_orphaned_202210 m on m.id_results = d.id
      WHERE p.id isNULL
