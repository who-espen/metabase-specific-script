 ...
 * Variable to rename v_espen_lr_oncho_ias_2_participant_202112_v2_2, v_espen_ng_ng_oncho_oias_3_resultat_fts_202207_v2, metabase_ng_oncho_oias_orphaned_202207
 */
    ...
    FROM v_espen_lr_oncho_ias_2_participant_202112_v2_2 p
      LEFT JOIN v_espen_ng_ng_oncho_oias_3_resultat_fts_202207_v2 d on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_ng_oncho_oias_orphaned_202207 m on m.id_participant = p.id
    ...
    FROM v_espen_ng_ng_oncho_oias_3_resultat_fts_202207_v2 d
      LEFT JOIN v_espen_lr_oncho_ias_2_participant_202112_v2_2 p on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_ng_oncho_oias_orphaned_202207 m on m.id_results = d.id
