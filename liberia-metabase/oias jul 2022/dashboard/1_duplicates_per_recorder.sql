 ...
 * Variable to rename metabase_ng_oncho_oias_duplicates_202207? espen_ng_ng_oncho_oias_3_resultat_fts_202207_v2
 */
  SELECT
    ...
    FROM public.metabase_ng_oncho_oias_duplicates_202207 m
    JOIN public.v_espen_lr_oncho_ias_2_participant_202112_v2_2 p ON p.id = m.id_participant
