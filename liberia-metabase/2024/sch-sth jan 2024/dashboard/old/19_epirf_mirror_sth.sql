...
INITCAP(p_subdistrict) "Ward"
FROM
    public.v_espen_lr_sch_sth_impact_202401_2_child_v2_1 p

left join public.v_espen_lr_sch_sth_impact_202401_1_school_v2 w on w.w_site_name = p.p_site
left join public.v_espen_lr_sch_sth_impact_202401_3_kato_katz_v2_1 k on k.k_code_id = p.p_code_id
left join public.v_espen_lr_sch_sth_impact_202401_4_urine_v2_1 u on u.u_code_id = p.p_code_id
