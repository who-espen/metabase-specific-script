...
FROM
    ...
    left join public.v_espen_lr_sch_sth_impact_202401_3_kato_katz_v2_1_full k on p.p_code_id = k.k_code_id
    left join public.v_espen_lr_sch_sth_impact_202401_4_urine_v2_1_full u on p.p_code_id = u.u_espen_code_id
