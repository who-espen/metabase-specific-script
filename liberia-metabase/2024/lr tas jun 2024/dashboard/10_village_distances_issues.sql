 ...
 * Variable to rename espen_lr_lf_tas1_1_site_202406_v1, <%village_dist_required%>
 */
SELECT
...
FROM espen_lr_lf_tas1_1_site_202406_v1 src
  JOIN espen_lr_lf_tas1_1_site_202406_v1 dest on (
