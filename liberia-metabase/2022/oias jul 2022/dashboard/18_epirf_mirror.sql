 ...
 * Variable to rename Pre TAS, v_espen_ng_ng_oncho_oias_3_resultat_fts_202207_v2, v_espen_lr_oncho_ias_2_participant_202112_v2_2,
...
JOIN espen_ng_ng_oncho_oias_1_site_202207_v2 c on d.d_cluster_id = c.c_site_id
JOIN v_espen_lr_oncho_ias_2_participant_202112_v2_2 p on p.p_code_id = d.d_code_id

GROUP BY c_district, c_site_name, "Month", "Year", c_gps_lat, c_gps_lng

order by c_district, c_site_name