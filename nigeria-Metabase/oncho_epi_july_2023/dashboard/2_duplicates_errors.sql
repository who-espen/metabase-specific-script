 ...
 * Variable to rename metabase_ng_oncho_prestop_duplicates_202307, v_espen_ng_oncho_stop_9_participant_202206_bauchy, v_espen_ng_oncho_stop_10_elisa_202206_bauchy
 */
...
FROM (
        SELECT
            ...
            status "Status"
        FROM
            metabase_ng_oncho_prestop_duplicates_202307 AS m,
            v_espen_ng_oncho_stop_9_participant_202206_bauchy AS p
        WHERE
