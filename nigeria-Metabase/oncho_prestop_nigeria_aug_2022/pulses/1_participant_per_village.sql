 ...
 * Variable to rename v_espen_ng_oncho_prestop_1_site_202208, v_espen_ng_oncho_prestop_2_participant_202208
 */
 SELECT
...
FROM v_espen_ng_oncho_prestop_1_site_202208 c
LEFT JOIN v_espen_ng_oncho_prestop_2_participant_202208 p ON c.c_cluster_id = p.p_cluster_id::INT
