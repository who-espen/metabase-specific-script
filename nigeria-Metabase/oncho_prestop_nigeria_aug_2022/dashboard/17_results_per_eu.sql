 ...
 * Variable to rename v_espen_ng_oncho_prestop_2_participant_202208, espen_ng_ng_oncho_prestop_1_site_202208_v2
 */
 SELECT
...
LEFT JOIN espen_ng_ng_oncho_prestop_1_site_202208_v2 c on d.d_cluster_id::int = c.c_cluster_id
RIGHT JOIN v_espen_ng_oncho_prestop_2_participant_202208 p on p.p_code_id = d.d_code_id
