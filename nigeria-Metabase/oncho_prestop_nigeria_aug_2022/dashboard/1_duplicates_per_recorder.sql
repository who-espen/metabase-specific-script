 ...
 * Variable to rename metabase_ng_oncho_prestop_duplicates_202208? espen_ng_ng_oncho_prestop_3_resultat_fts_202208_v2
 */
  SELECT
    ...
    FROM public.metabase_ng_oncho_prestop_duplicates_202208 m
    JOIN public.v_espen_ng_oncho_prestop_2_participant_202208 p ON p.id = m.id_participant
