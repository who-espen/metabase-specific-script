 ...
 * Variable to rename v_espen_ng_oncho_prestop_2_participant_202208, v_espen_ng_ng_oncho_prestop_3_resultat_fts_202208_v2, metabase_ng_oncho_prestop_orphaned_202208
 */
    ...
    FROM v_espen_ng_oncho_prestop_2_participant_202208 p
      LEFT JOIN v_espen_ng_ng_oncho_prestop_3_resultat_fts_202208_v2 d on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_ng_oncho_prestop_orphaned_202208 m on m.id_participant = p.id
    ...
    FROM v_espen_ng_ng_oncho_prestop_3_resultat_fts_202208_v2 d
      LEFT JOIN v_espen_ng_oncho_prestop_2_participant_202208 p on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_ng_oncho_prestop_orphaned_202208 m on m.id_results = d.id
