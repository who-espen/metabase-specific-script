 ...
 * Variable to rename metabase_ng_oncho_oem_duplicates_202204? espen_ng_ng_oncho_oem_3_resultat_fts_202204_v2
 */
  SELECT
    ...
    FROM public.metabase_ng_oncho_oem_duplicates_202204 m
    JOIN public.v_espen_ng_oncho_oem_2_participant_202204 p ON p.id = m.id_participant
