 ...
 * Variable to rename v_espen_ng_oncho_202301_prestop_2_participant, v_espen_ng_ng_oncho_prestop_3_resultat_fts_202304_v2, metabase_ng_oncho_prestop_orphaned_202304
 */
    ...
    FROM v_espen_ng_oncho_202301_prestop_2_participant p
      LEFT JOIN v_espen_ng_ng_oncho_prestop_3_resultat_fts_202304_v2 d on p.p_code_id = d.d_code_id
    ...
    FROM v_espen_ng_ng_oncho_prestop_3_resultat_fts_202304_v2 d
      LEFT JOIN v_espen_ng_oncho_202301_prestop_2_participant p on p.p_code_id = d.d_code_id
