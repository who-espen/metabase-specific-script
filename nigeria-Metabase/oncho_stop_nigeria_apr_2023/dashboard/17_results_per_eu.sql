 ...
 * Variable to rename v_espen_ng_oncho_202301_prestop_2_participant, espen_ng_ng_oncho_prestop_1_site_202304_v2
 */
 SELECT
...
LEFT JOIN espen_ng_ng_oncho_prestop_1_site_202304_v2 c on d.d_cluster_id::int = c.c_cluster_id
RIGHT JOIN v_espen_ng_oncho_202301_prestop_2_participant p on p.p_code_id = d.d_code_id
