 ...
 * Variable to rename v_espen_ng_oncho_202301_prestop_2_participant, v_espen_ng_ng_oncho_prestop_3_resultat_fts_202304_v2
 */
 SELECT
...
FROM v_espen_ng_oncho_202301_prestop_2_participant p
  LEFT JOIN v_espen_ng_ng_oncho_prestop_3_resultat_fts_202304_v2 d on d.d_code_id = p.p_code_id
