 ...
 * Variable to rename espen_ng_lf_pretas_1_site_202102_v2, <%village_dist_required%>
 */
SELECT
...
FROM espen_ng_lf_pretas_1_site_202102_v2 src
  JOIN espen_ng_lf_pretas_1_site_202102_v2 dest on (
