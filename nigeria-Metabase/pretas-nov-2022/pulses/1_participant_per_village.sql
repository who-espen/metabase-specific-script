 ...
 * Variable to rename v_espen_ng_lf_pretas_1_site_202211_v1, v_espen_ng_lf_pretas_2_participant_202211
 */
 SELECT
...
FROM v_espen_ng_lf_pretas_1_site_202211_v1 c
LEFT JOIN v_espen_ng_lf_pretas_2_participant_202211 p ON c.c_cluster_id = p.p_cluster_id::INT
