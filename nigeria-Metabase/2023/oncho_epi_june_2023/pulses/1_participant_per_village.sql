 ...
 * Variable to rename v_espen_ng_oncho_stop_4_site_202306, v_espen_ng_oncho_stop_5_participant_202206
 */
...
FROM
    v_espen_ng_oncho_stop_4_site_202306 c
    LEFT JOIN v_espen_ng_oncho_stop_5_participant_202206 p ON c.c_cluster_id = p.p_cluster_id:: INT
where
