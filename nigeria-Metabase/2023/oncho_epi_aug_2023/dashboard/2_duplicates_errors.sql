 ...
 * Variable to rename metabase_ng_oncho_prestop_duplicates_202308, v_espen_ng_oncho_stop_13_participant_202206_niger, v_espen_ng_oncho_stop_10_elisa_202206_bauchy
 */
...
FROM (
        SELECT
            ...
            status "Status"
        FROM
            metabase_ng_oncho_prestop_duplicates_202308 AS m,
            v_espen_ng_oncho_stop_13_participant_202206_niger AS p
        WHERE
