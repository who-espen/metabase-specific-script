 ...
 * Variable to rename metabase_ng_oncho_prestop_duplicates_202308? espen_ng_oncho_stop_10_elisa_202206_bauchy
 */
SELECT
...
FROM
    public.metabase_ng_oncho_prestop_duplicates_202308 m
    JOIN public.v_espen_ng_oncho_stop_13_participant_202206_niger p ON p.id = m.id_participant
group by
    p.p_recorder_id,
    p_district,
    p_cluster_id,
