 ...
 * Variable to rename v_espen_ng_oncho_stop_8_site_202306_bauchy, v_espen_ng_oncho_stop_9_participant_202206_bauchy
 */
...
FROM
    v_espen_ng_oncho_stop_8_site_202306_bauchy c
    LEFT JOIN v_espen_ng_oncho_stop_9_participant_202206_bauchy p ON c.c_cluster_id = p.p_cluster_id:: INT
where
