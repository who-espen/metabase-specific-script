 ...
 * Variable to rename Pre TAS, v_espen_ng_oncho_stop_10_elisa_202206_bauchy, v_espen_ng_oncho_stop_9_participant_202206_bauchy,
...
FROM
    ...
    JOIN v_espen_ng_oncho_stop_9_participant_202206_bauchy p on p.p_code_id = d.d_code_id
GROUP BY
    c_district,
    c_cluster_name,
    "Month",
