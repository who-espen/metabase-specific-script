 ...
 * Variable to rename v_espen_ng_oncho_stop_13_participant_202206_niger, espen_ng_ng_oncho_prestop_1_site_202304_v2
 */
...
FROM
    ...
    RIGHT JOIN v_espen_ng_oncho_stop_13_participant_202206_niger p on p.p_code_id = d.d_code_id
WHERE
