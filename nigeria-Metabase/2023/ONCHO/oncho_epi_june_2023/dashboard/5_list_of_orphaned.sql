 ...
 * Variable to rename v_espen_ng_oncho_stop_5_participant_202206, v_espen_ng_oncho_stop_6_rdtov16_202206, metabase_ng_oncho_prestop_orphaned_202304
 */
...
SELECT
    ...
    status "Status"
FROM
    v_espen_ng_oncho_stop_5_participant_202206 p
    LEFT JOIN v_espen_ng_oncho_stop_6_rdtov16_202206 d on p.p_code_id = d.d_code_id
...
SELECT
    ...
    status "Status"
FROM
    v_espen_ng_oncho_stop_6_rdtov16_202206 d
    LEFT JOIN v_espen_ng_oncho_stop_5_participant_202206 p on p.p_code_id = d.d_code_id
