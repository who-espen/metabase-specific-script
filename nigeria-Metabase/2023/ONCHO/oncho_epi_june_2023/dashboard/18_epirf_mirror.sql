 ...
 * Variable to rename Pre TAS, v_espen_ng_oncho_stop_6_rdtov16_202206, v_espen_ng_oncho_stop_5_participant_202206,
...
FROM
    ...
    JOIN v_espen_ng_oncho_stop_5_participant_202206 p on p.p_code_id = d.d_code_id
GROUP BY
    c_district,
    c_cluster_name,
    "Month",
