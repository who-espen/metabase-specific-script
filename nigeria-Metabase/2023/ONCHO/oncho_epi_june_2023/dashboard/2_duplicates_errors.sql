 ...
 * Variable to rename metabase_ng_oncho_pre_duplicates_202306, v_espen_ng_oncho_stop_5_participant_202206, v_espen_ng_oncho_stop_6_rdtov16_202206
 */
...
FROM (
        SELECT
            ...
            status "Status"
        FROM
            metabase_ng_oncho_pre_duplicates_202306 AS m,
            v_espen_ng_oncho_stop_5_participant_202206 AS p
        WHERE
       ...
       -- FROM
       --     metabase_ng_oncho_pre_duplicates_202306 AS m,
       --     public.v_espen_ng_oncho_stop_6_rdtov16_202206 AS d
       -- WHERE
       --     d.id = m.id_results
    ) src
