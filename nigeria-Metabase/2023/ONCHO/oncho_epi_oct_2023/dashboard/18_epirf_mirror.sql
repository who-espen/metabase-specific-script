 ...
 * Variable to rename Pre TAS, v_espen_ng_oncho_stop_3_rdtov16_202310, v_espen_ng_oncho_stop_2_participant_202310,
...
FROM
    ...
    JOIN v_espen_ng_oncho_stop_2_participant_202310 p on p.p_code_id = d.d_code_id
GROUP BY
    c_district,
    c_cluster_name,
    "Month",
