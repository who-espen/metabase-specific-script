 ...
 * Variable to rename espen_bj_oncho_prestop_1_site,  v_espen_ng_oncho_stop_3_rdtov16_202310
 */
...
FROM
    ...
    LEFT JOIN v_espen_ng_oncho_stop_3_rdtov16_202310 d on c.c_cluster_id = d.d_cluster_id
where
