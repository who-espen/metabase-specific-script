...
/*
 * Variable to rename metabase_ng_oncho_prestop_duplicates_202307, identify_participant_duplicate_pretas_202304, v_espen_ng_oncho_202301_stop_2_participant,
 * v_espen_ng_ng_oncho_stop_3_resultat_fts_202304_v2, metabase_ng_oncho_stop_result_duplicates_202304_trigger, metabase_ng_oncho_prestop_duplicates_202307_trigger,
...
CREATE TABLE
    IF NOT EXISTS metabase_ng_oncho_prestop_duplicates_202307(
...
CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_participant_id_barcode_ng_oncho_stop_202304 ON metabase_ng_oncho_prestop_duplicates_202307(
    id_participant,
    barcode_participant
);
...
--   ON metabase_ng_oncho_prestop_duplicates_202307(id_results, barcode_results);
...
-- CREATE TRIGGER metabase_ng_oncho_prestop_duplicates_202307_trigger AFTER INSERT OR UPDATE OR DELETE ON espen_ng_ng_oncho_stop_2_participant_202304_v2
