 ...
 * Variable to rename v_espen_ng_oncho_stop_9_participant_202206_bauchy, espen_ng_ng_oncho_prestop_1_site_202304_v2
 */
...
FROM
    ...
    RIGHT JOIN v_espen_ng_oncho_stop_9_participant_202206_bauchy p on p.p_code_id = d.d_code_id
WHERE
