 ...
 * Variable to rename v_espen_ng_oncho_stop_9_participant_202206_bauchy, v_espen_ng_oncho_stop_10_elisa_202206_bauchy, metabase_ng_oncho_prestop_orphaned_202304
 */
...
SELECT
    ...
    status "Status"
FROM
    v_espen_ng_oncho_stop_9_participant_202206_bauchy p
    LEFT JOIN v_espen_ng_oncho_stop_10_elisa_202206_bauchy d on p.p_code_id = d.d_code_id
...
FROM
    ...
    LEFT JOIN v_espen_ng_oncho_stop_9_participant_202206_bauchy p on p.p_code_id = d.d_code_id
