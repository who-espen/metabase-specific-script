 ...
 * Variable to rename espen_bj_oncho_prestop_1_site,  v_espen_ng_oncho_stop_10_elisa_202206_bauchy
 */
...
FROM
    ...
    LEFT JOIN v_espen_ng_oncho_stop_10_elisa_202206_bauchy d on c.c_cluster_id = d.d_cluster_id
where
