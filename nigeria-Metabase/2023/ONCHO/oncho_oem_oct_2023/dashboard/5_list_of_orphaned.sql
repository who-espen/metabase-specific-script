 ...
 * Variable to rename v_espen_ng_oncho_oem_2_participant_202310, v_espen_ng_oncho_stop_3_rdtov16_202310, metabase_ng_oncho_prestop_orphaned_202304
 */
...
SELECT
    ...
    status "Status"
FROM
    v_espen_ng_oncho_oem_2_participant_202310 p
...
FROM
    ...
    LEFT JOIN v_espen_ng_oncho_oem_2_participant_202310 p on p.p_code_id = d.d_code_id
