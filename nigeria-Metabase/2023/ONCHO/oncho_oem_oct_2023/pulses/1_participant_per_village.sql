 ...
 * Variable to rename v_espen_ng_oncho_oem_1_site_202310, v_espen_ng_oncho_oem_2_participant_202310
 */
...
FROM
    v_espen_ng_oncho_oem_1_site_202310 c
    LEFT JOIN v_espen_ng_oncho_oem_2_participant_202310 p ON c.c_cluster_id = p.p_cluster_id:: INT
where
