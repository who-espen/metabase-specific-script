...
LEFT JOIN espen_ng_lf_pretas_1_site_202211_v1 c on d.d_cluster_id::int = c.c_cluster_id
RIGHT JOIN v_espen_ng_lf_pretas_2_participant_202211 p on p.p_code_id = d.d_code_id
