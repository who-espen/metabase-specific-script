 ...
 * Variable to rename metabase_ng_lf_pretas_duplicates_202212? espen_ng_lf_pretas_3_resultat_fts_202211
 */
...
FROM (
  SELECT
    ...
    FROM public.metabase_ng_lf_pretas_duplicates_202212 m
    JOIN v_espen_ng_lf_pretas_3_resultat_fts_202211 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_ng_lf_pretas_duplicates_202212 m
    JOIN espen_ng_lf_pretas_2_participant_202211 p ON p.id = m.id_participant
