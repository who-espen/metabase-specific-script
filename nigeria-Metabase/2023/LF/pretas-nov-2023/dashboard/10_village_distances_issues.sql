 ...
 * Variable to rename espen_ng_lf_pretas_202309_1_site_v3, <%village_dist_required%>
 */
SELECT
...
FROM espen_ng_lf_pretas_202309_1_site_v3 src
  JOIN espen_ng_lf_pretas_202309_1_site_v3 dest on (
