 ...
 * Variable to rename metabase_ng_lf_pretas_duplicates_202310? espen_ng_lf_pretas_202309_3_resultat_fts_v3
 */
...
FROM (
  SELECT
    ...
    FROM public.metabase_ng_lf_pretas_duplicates_202310 m
    JOIN v_espen_ng_lf_pretas_202309_3_resultat_fts_v3 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_ng_lf_pretas_duplicates_202310 m
    JOIN v_espen_ng_lf_pretas_202309_2_participant_v3 p ON p.id = m.id_participant
