 ...
 * Variable to rename metabase_lf_pretas_duplicates_202102? espen_ng_lf_pretas_3_resultat_fts_202102_v2
 */
 SELECT
...
FROM (
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202102 m
    JOIN v_espen_ng_lf_pretas_3_resultat_fts_202102_v2 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202102 m
    JOIN espen_ng_lf_pretas_2_participant_202102_v2 p ON p.id = m.id_participant
