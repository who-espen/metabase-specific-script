 ...
 * Variable to rename v_espen_ng_lf_tas_2406_1_sit_part_kn_v32, v_espen_ng_lf_tas_2406_1_sit_part_kn_v32
 */
 SELECT
...
LEFT JOIN v_espen_ng_lf_tas_2406_1_sit_part_kn_v32 p ON c.c_cluster_id = p.p_cluster_id::INT
