 ...
 * Variable to rename v_espen_ng_lf_tas_2410_1_sit_part_kg, v_espen_ng_lf_tas_2410_1_sit_part_kg
 */
 SELECT
...
FROM v_espen_ng_lf_tas_2410_1_sit_part_kg c
LEFT JOIN v_espen_ng_lf_tas_2410_1_sit_part_kg p ON c.c_cluster_id = p.p_cluster_id::INT
