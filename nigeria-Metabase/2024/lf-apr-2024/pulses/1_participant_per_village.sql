 ...
 * Variable to rename v_espen_ng_lf_pretas_202404_1_site_v2, v_espen_ng_lf_pretas_202404_2_participant_v2
 */
 SELECT
...
FROM v_espen_ng_lf_pretas_202404_1_site_v2 c
LEFT JOIN v_espen_ng_lf_pretas_202404_2_participant_v2 p ON c.c_cluster_id = p.p_cluster_id::INT
