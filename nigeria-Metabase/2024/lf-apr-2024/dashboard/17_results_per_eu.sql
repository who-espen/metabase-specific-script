...
LEFT JOIN espen_ng_lf_pretas_202404_1_site_v2 c on d.d_cluster_id::int = c.c_cluster_id
RIGHT JOIN v_espen_ng_lf_pretas_202404_2_participant_v2 p on p.p_code_id = d.d_code_id
