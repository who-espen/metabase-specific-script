 ...
 * Variable to rename metabase_ng_lf_pretas_duplicates_202404, espen_ng_lf_tas_202404_3_resultat_fts_jgw_v3, espen_ng_lf_pretas_202404_2_participant_v2
 */
 SELECT
 COUNT(barcode_participant) "Total duplicates",
 p.p_start::date "Date"
FROM metabase_ng_lf_pretas_duplicates_202404 AS m, v_espen_ng_lf_pretas_202404_2_participant_v2 AS p
...
SELECT
 ...
 d.d_start::date "Date"
FROM metabase_ng_lf_pretas_duplicates_202404 AS m, v_espen_ng_lf_pretas_202404_3_fts_v2 AS d
