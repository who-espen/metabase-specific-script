 ...
 * Variable to rename espen_ng_lf_pretas_202404_1_site_v2, <%village_dist_required%>
 */
SELECT
...
FROM espen_ng_lf_pretas_202404_1_site_v2 src
  JOIN espen_ng_lf_pretas_202404_1_site_v2 dest on (
