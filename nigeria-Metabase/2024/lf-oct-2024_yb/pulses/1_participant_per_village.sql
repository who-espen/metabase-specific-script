 ...
 * Variable to rename v_espen_ng_lf_tas_2410_2_fts_yb_v2, v_espen_ng_lf_tas_2410_2_fts_yb_v2
 */
 SELECT
...
FROM v_espen_ng_lf_tas_2410_2_fts_yb_v2 c
LEFT JOIN v_espen_ng_lf_tas_2410_2_fts_yb_v2 p ON c.c_cluster_id = p.p_cluster_id::INT
