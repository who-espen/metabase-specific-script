 ...
 select
    ...
    where (select count(*) from v_espen_ng_lf_tas_2410_1_sit_part_yb k where p.p_code_id = k.p_code_id) > 1
    ...
    where (select count(*) from v_espen_ng_lf_tas_2410_2_fts_yb r where d.d_code_id = r.d_code_id) > 1