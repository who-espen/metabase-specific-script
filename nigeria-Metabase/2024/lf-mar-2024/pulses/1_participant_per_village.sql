 ...
 * Variable to rename v_espen_ng_lf_tas_202403_1_site_bay_v2_1, v_espen_ng_lf_tas_202403_2_participant_bay_v2
 */
 SELECT
...
LEFT JOIN v_espen_ng_lf_tas_202403_2_participant_bay_v2 p ON c.c_cluster_id = p.p_cluster_id::INT
