 ...
 * Variable to rename metabase_ng_lf_pretas_duplicates_202402_bay? espen_ng_lf_tas_202402_bay_3_resultat_fts_jgw_v3
 */
...
FROM (
  SELECT
    ...
    FROM public.metabase_ng_lf_pretas_duplicates_202402_bay m
    JOIN v_espen_ng_lf_tas_202403_3_fts_bay_v2_2 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_ng_lf_pretas_duplicates_202402_bay m
    JOIN v_espen_ng_lf_tas_202403_2_participant_bay_v2 p ON p.id = m.id_participant
