 ...
 * Variable to rename espen_ng_lf_tas_202403_1_site_bay_v2_1, <%village_dist_required%>
 */
SELECT
...
FROM espen_ng_lf_tas_202403_1_site_bay_v2_1 src
  JOIN espen_ng_lf_tas_202403_1_site_bay_v2_1 dest on (
