 ...
 * Variable to rename v_espen_ng_lf_tas_202403_2_participant_bay_v2, v_espen_ng_lf_tas_202403_3_fts_bay_v2_2, metabase_ng_lf_pretas_orphaned_202402_bay
 */
    ...
    FROM v_espen_ng_lf_tas_202403_2_participant_bay_v2 p
      ...
      LEFT JOIN metabase_ng_lf_pretas_orphaned_202402_bay m on m.id_participant = p.id
    ...
    FROM v_espen_ng_lf_tas_202403_3_fts_bay_v2_2 d
      LEFT JOIN v_espen_ng_lf_tas_202403_2_participant_bay_v2 p on p.p_code_id = d.d_code_id
      LEFT JOIN metabase_ng_lf_pretas_orphaned_202402_bay m on m.id_results = d.id
