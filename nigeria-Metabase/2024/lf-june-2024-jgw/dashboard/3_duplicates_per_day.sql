 ...
 * Variable to rename metabase_ng_lf_2406_tas2_duplicates, espen_ng_lf_tas_202405_3_resultat_fts_jgw_v3, espen_ng_lf_tas_202405_2_part_ben_oy_v2
 */
 SELECT
 COUNT(barcode_participant) "Total duplicates",
 p.p_start::date "Date"
FROM metabase_ng_lf_2406_tas2_duplicates AS m, v_espen_ng_lf_tas_2406_1_sit_part_jgw_v31 AS p
...
SELECT
 ...
 d.d_start::date "Date"
FROM metabase_ng_lf_2406_tas2_duplicates AS m, v_espen_ng_lf_tas_2406_2_fts_jgw_v31 AS d
