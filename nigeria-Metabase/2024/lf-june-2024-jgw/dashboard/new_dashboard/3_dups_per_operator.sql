...
FROM
    public.metabase_ng_lf_2406_tas2_duplicates m
    JOIN v_espen_ng_lf_tas_2406_2_fts_jgw_v31 k ON k.id = m.id_results_fts :: int
...
FROM
    public.metabase_ng_lf_2406_tas2_duplicates m
    JOIN v_espen_ng_lf_tas_2406_1_sit_part_jgw_v31 p ON (p.id = m.id_participant:: int)
