 ...
 * Variable to rename v_espen_ng_oncho_stop_3_rdtov16_202404, v_espen_ng_oncho_stop_202404_2_part_adam_v2, espen_ng_ng_oncho_stop_1_site_202304_v2
 */
...
SELECT
    ...
    c_date "Date"
FROM
    public.v_espen_ng_oncho_stop_202404_1_site_adam_v2 c,
    v_espen_ng_oncho_stop_202404_2_part_adam_v2 p,
    v_espen_ng_oncho_stop_3_rdtov16_202404 d
where
    p.p_cluster_id = c.c_cluster_id
    and p.p_code_id = d.d_code_id;