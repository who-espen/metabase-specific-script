 ...
 * Variable to rename v_espen_ng_lf_tas_202404_1_s_ben_oy, v_espen_ng_lf_tas_202404_2_part_ben_oy_v2
 */
 SELECT
...
LEFT JOIN v_espen_ng_lf_tas_202404_2_part_ben_oy_v2 p ON c.c_cluster_id = p.p_cluster_id::INT
