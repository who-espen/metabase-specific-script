 ...
 * Variable to rename metabase_ng_lf_tas_duplicates_202405? espen_ng_lf_tas_202405_3_resultat_fts_jgw_v3
 */
...
FROM (
  SELECT
    ...
    FROM public.metabase_ng_lf_tas_duplicates_202405 m
    JOIN v_espen_ng_lf_tas_202404_3_fts_ben_oy_v2 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_ng_lf_tas_duplicates_202405 m
    JOIN v_espen_ng_lf_tas_202404_2_part_ben_oy_v2 p ON p.id = m.id_participant
