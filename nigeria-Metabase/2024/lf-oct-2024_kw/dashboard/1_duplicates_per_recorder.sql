 ...
 * Variable to rename metabase_ng_lf_2410_tas1_duplicates_kw? espen_ng_lf_tas_202405_3_resultat_fts_jgw_v3
 */
...
FROM (
  SELECT
    ...
    FROM public.metabase_ng_lf_2410_tas1_duplicates_kw m
    JOIN v_espen_ng_lf_tas_2410_2_fts_kw d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_ng_lf_2410_tas1_duplicates_kw m
    JOIN v_espen_ng_lf_tas_2410_2_fts_kw_v2 p ON p.id = m.id_participant
