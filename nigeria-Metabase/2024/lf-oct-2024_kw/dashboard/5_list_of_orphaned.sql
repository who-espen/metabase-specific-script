 ...
 * Variable to rename v_espen_ng_lf_tas_2410_2_fts_kw_v2, v_espen_ng_lf_tas_2410_2_fts_kw, metabase_ng_lf_tas_orphaned_202405
 */
    ...
    FROM v_espen_ng_lf_tas_2410_2_fts_kw_v2 p
    ...
    FROM v_espen_ng_lf_tas_2410_2_fts_kw d
      LEFT JOIN v_espen_ng_lf_tas_2410_2_fts_kw_v2 p on p.p_code_id = d.d_code_id
