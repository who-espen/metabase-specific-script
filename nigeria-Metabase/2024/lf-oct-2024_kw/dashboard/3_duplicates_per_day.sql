 ...
 * Variable to rename metabase_ng_lf_2410_tas1_duplicates_kw, espen_ng_lf_tas_202405_3_resultat_fts_jgw_v3, espen_ng_lf_tas_202405_2_part_ben_oy_v2
 */
 SELECT
 COUNT(barcode_participant) "Total duplicates",
 p.p_start::date "Date"
FROM metabase_ng_lf_2410_tas1_duplicates_kw AS m, v_espen_ng_lf_tas_2410_2_fts_kw_v2 AS p
...
SELECT
 ...
 d.d_start::date "Date"
FROM metabase_ng_lf_2410_tas1_duplicates_kw AS m, v_espen_ng_lf_tas_2410_2_fts_kw AS d
