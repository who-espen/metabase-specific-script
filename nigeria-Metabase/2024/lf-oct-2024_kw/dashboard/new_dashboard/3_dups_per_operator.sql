...
FROM
    public.metabase_ng_lf_2410_tas1_duplicates_kw m
    JOIN v_espen_ng_lf_tas_2410_2_fts_kw k ON k.id = m.id_results_fts :: int
...
FROM
    public.metabase_ng_lf_2410_tas1_duplicates_kw m
    JOIN v_espen_ng_lf_tas_2410_1_sit_part_kw p ON (p.id = m.id_participant:: int)
