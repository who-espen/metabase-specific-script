 ...
 * Variable to rename metabase_ng_lf_pretas_duplicates_202402? espen_ng_lf_tas_202402_3_resultat_fts_jgw_v3
 */
...
FROM (
  SELECT
    ...
    FROM public.metabase_ng_lf_pretas_duplicates_202402 m
    JOIN v_espen_ng_lf_tas_202402_3_resultat_fts_jgw_v3 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_ng_lf_pretas_duplicates_202402 m
    JOIN v_espen_ng_lf_tas_202402_2_participant_jgw_v2_1 p ON p.id = m.id_participant
