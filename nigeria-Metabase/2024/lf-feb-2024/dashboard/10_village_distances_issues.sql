 ...
 * Variable to rename espen_ng_lf_tas_202402_1_site_jgw_v2_2, <%village_dist_required%>
 */
SELECT
...
FROM espen_ng_lf_tas_202402_1_site_jgw_v2_2 src
  JOIN espen_ng_lf_tas_202402_1_site_jgw_v2_2 dest on (
