 ...
 * Variable to rename v_espen_ng_lf_tas_2406_1_sit_part_kb_v31, v_espen_ng_lf_tas_2406_1_sit_part_kb_v31
 */
 SELECT
...
FROM v_espen_ng_lf_tas_2406_1_sit_part_kb_v31 c
LEFT JOIN v_espen_ng_lf_tas_2406_1_sit_part_kb_v31 p ON c.c_cluster_id = p.p_cluster_id::INT
