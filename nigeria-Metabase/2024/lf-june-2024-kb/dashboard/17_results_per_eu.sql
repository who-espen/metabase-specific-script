 ...
 * Variable to rename v_espen_ng_lf_tas_2406_1_sit_part_kb_v31, espen_ng_lf_tas_2406_1_s_ben_oy
 */
 SELECT
...
FROM v_espen_ng_lf_tas_2406_2_fts_kb_v31 d
LEFT JOIN espen_ng_lf_tas_2406_1_s_ben_oy c on d.d_cluster_id::int = c.c_cluster_id
RIGHT JOIN v_espen_ng_lf_tas_2406_1_sit_part_kb_v31 p on p.p_code_id = d.d_code_id
