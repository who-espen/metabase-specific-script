 ...
 * Variable to rename metabase_ng_lf_2407_tas1_duplicates_kb? espen_ng_lf_tas_2406_3_resultat_fts_ng_v3
 */
...
FROM (
  SELECT
    ...
    FROM public.metabase_ng_lf_2407_tas1_duplicates_kb m
    JOIN v_espen_ng_lf_tas_2406_2_fts_kb_v31 d ON d.id = m.id_results
  ...
  SELECT
    ...
    FROM public.metabase_ng_lf_2407_tas1_duplicates_kb m
    JOIN v_espen_ng_lf_tas_2406_1_sit_part_kb_v31 p ON p.id = m.id_participant
