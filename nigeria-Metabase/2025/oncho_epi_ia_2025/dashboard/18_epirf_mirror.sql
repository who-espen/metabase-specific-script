 ...
 * Variable to rename Pre TAS, v_espen_ng_oncho_stop_3_rdtov16_202404, v_espen_ng_oncho_stop_202404_2_part_adam_v2,
...
FROM
    ...
    JOIN espen_ng_ng_oncho_stop_1_site_202304_v2 c on d.d_cluster_id = c.c_cluster_id
    JOIN v_espen_ng_oncho_stop_202404_2_part_adam_v2 p on p.p_code_id = d.d_code_id
GROUP BY
    c_district,
    c_cluster_name,
    "Month",
