 ...
 * Variable to rename espen_ng_ng_oncho_oem_1_site_202204_v2, v_espen_ng_oncho_oem_2_participant_202204
 */
SELECT
...
JOIN v_espen_ng_oncho_oem_2_participant_202204 p ON p.p_cluster_id::INT = c.c_cluster_id
