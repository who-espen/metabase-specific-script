 ...
 * Variable to rename v_espen_ng_oncho_oem_2_participant_202204, v_espen_ng_ng_oncho_oem_3_resultat_fts_202204_v2
 */
 SELECT
...
FROM v_espen_ng_oncho_oem_2_participant_202204 p
  LEFT JOIN v_espen_ng_ng_oncho_oem_3_resultat_fts_202204_v2 d on d.d_code_id = p.p_code_id
