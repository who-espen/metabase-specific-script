 ...
 * Variable to rename v_espen_ng_oncho_oem_1_site_202204, v_espen_ng_oncho_oem_2_participant_202204
 */
 SELECT
...
FROM v_espen_ng_oncho_oem_1_site_202204 c
LEFT JOIN v_espen_ng_oncho_oem_2_participant_202204 p ON c.c_cluster_id = p.p_cluster_id::INT
