 ...
 * Variable to rename v_espen_ng_oncho_stop_202404_2_part_adam_v2, espen_ng_ng_oncho_stop_1_site_202304_v2
 */
...
FROM
    ...
    LEFT JOIN espen_ng_ng_oncho_stop_1_site_202304_v2 c on d.d_cluster_id:: int = c.c_cluster_id
    RIGHT JOIN v_espen_ng_oncho_stop_202404_2_part_adam_v2 p on p.p_code_id = d.d_code_id
WHERE
