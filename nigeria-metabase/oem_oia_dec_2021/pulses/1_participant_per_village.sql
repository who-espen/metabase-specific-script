 ...
 * Variable to rename <%ab_cde_fgh_3_rdt_ov16%>, v_espen_ng_oncho_oem_2_participant_202112_v2_2
 */
 SELECT
...
LEFT JOIN v_espen_ng_oncho_oem_2_participant_202112_v2_2 c ON c.c_cluster_id = p.p_cluster_id::INT
