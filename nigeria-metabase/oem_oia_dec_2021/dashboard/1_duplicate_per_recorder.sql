...
FROM (
      ...
      FROM metabase_oncho_oias_duplicates_202112 m, v_espen_ng_oncho_oem_2_participant_202112_v2_2 p
      ...
      FROM metabase_oncho_oias_duplicates_202112 m, v_espen_ng_oncho_oem_2_participant_202112_v2_2 d
