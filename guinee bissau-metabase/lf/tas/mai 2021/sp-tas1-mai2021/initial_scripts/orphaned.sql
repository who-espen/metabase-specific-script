...
/*
 * Variable to rename metabase_lf_tas1_orphaned_202206, v_espen_gw_lf_tas1_2_partcipants_202206_v2_1
,
...
*/
  CREATE UNIQUE INDEX IF NOT EXISTS idx_orphaned_lf_tas1_participant_id_barcode_202206
    ON metabase_lf_tas1_orphaned_202206(id_participant, barcode_participant);
  CREATE UNIQUE INDEX IF NOT EXISTS idx_orphaned_lf_tas1_results_id_barcode_202206
    ON metabase_lf_tas1_orphaned_202206(id_results, barcode_results);

  ALTER TABLE metabase_lf_tas1_orphaned_202206
    ADD CONSTRAINT unique_idx_orphaned_lf_tas1_participant_id_barcode_202206
    UNIQUE USING INDEX idx_orphaned_lf_tas1_participant_id_barcode_202206;

  ALTER TABLE metabase_lf_tas1_orphaned_202206
    ADD CONSTRAINT unique_idx_orphaned_lf_tas1_results_id_barcode_202206
    UNIQUE USING INDEX idx_orphaned_lf_tas1_results_id_barcode_202206;
...
ON CONFLICT ON CONSTRAINT unique_idx_orphaned_lf_tas1_participant_id_barcode_202206 DO NOTHING;
  ...
  SELECT id, d_recorder_id, d_barcode_id, 'FTS results without participant'
    FROM (
      SELECT
        ...
        FROM v_espen_gw_lf_tas1_2_partcipants_202206_v2_1
 p
         RIGHT JOIN v_espen_gw_lf_tas1_3_fts_result_202206_v2_1
 d on p.p_barcode_id = d.d_barcode_id
          WHERE p.id isnull
          ) p
ON CONFLICT ON CONSTRAINT unique_idx_orphaned_lf_tas1_results_id_barcode_202206 DO NOTHING;
