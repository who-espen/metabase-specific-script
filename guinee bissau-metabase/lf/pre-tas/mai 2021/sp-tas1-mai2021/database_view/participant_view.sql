...
/*
 * Variable to rename  espen_gw_lf_pretas_2_partcipants_202206_v2_1
, v_espen_gw_lf_pretas_2_partcipants_202206_v2_1

 */
 CREATE OR REPLACE VIEW public.v_espen_gw_lf_pretas_2_partcipants_202206_v2_1 as
SELECT p.id,
    p.p_recorder_id,
    p.p_region,
    p.p_district,
   ...
   FROM public.espen_gw_lf_pretas_2_partcipants_202206_v2_1 p
