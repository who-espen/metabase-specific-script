...
CREATE TABLE IF NOT EXISTS metabase_lf_pretas_duplicates_202206(
...
*/
  CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_lf_pretas_participant_id_barcode_202206
    ON metabase_lf_pretas_duplicates_202206(id_participant, barcode_participant);
  CREATE UNIQUE INDEX IF NOT EXISTS idx_duplicates_lf_pretas_results_id_barcode_202206
    ON metabase_lf_pretas_duplicates_202206(id_results, barcode_results);

  ALTER TABLE metabase_lf_pretas_duplicates_202206
    ADD CONSTRAINT unique_idx_duplicates_lf_pretas_participant_id_barcode_202206
    UNIQUE USING INDEX idx_duplicates_lf_pretas_participant_id_barcode_202206;

  ALTER TABLE metabase_lf_pretas_duplicates_202206
    ADD CONSTRAINT unique_idx_duplicates_lf_pretas_results_id_barcode_202206
    UNIQUE USING INDEX idx_duplicates_lf_pretas_results_id_barcode_202206;
