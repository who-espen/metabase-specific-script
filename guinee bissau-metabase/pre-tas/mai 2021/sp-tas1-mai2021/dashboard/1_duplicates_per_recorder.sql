 ...
 * Variable to rename metabase_lf_pretas_duplicates_202206? espen_gw_lf_pretas_3_fts_result_202206_v2
...
FROM (
  SELECT
    ...
    FROM public.metabase_lf_pretas_duplicates_202206 m
    JOIN v_espen_gw_lf_pretas_3_fts_result_202206_v2
