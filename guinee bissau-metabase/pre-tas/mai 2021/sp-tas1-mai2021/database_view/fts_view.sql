...
/*
 * Variable to rename  v_espen_gw_lf_pretas_3_fts_result_202206_v2
, espen_gw_lf_pretas_3_fts_result_202206_v2
, espen_gw_lf_pretas_1_sites_202206_v2_1

 */
CREATE OR REPLACE VIEW public.v_espen_gw_lf_pretas_3_fts_result_202206_v2 AS 
SELECT d.id,
    d.d_recorder_id,
    d.d_region,
    d.d_district,
   ...
   FROM public.espen_gw_lf_pretas_3_fts_result_202206_v2 d;