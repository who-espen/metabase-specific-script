 ...
 * Variable to rename espen_ng_ng_oncho_prestop_1_site_202302_v2, <%village_dist_required%>
 */
SELECT
...
FROM espen_ng_ng_oncho_prestop_1_site_202302_v2 src
  JOIN espen_ng_ng_oncho_prestop_1_site_202302_v2 dest on (
