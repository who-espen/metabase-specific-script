 ...
 * Variable to rename v_espen_tg_oncho_stop_1_site_202204, v_espen_tg_oncho_stop_2_participants_202204
 */
 SELECT
...
LEFT JOIN v_espen_tg_oncho_stop_2_participants_202204 p ON c.c_cluster_id = p.p_cluster_id::INT
