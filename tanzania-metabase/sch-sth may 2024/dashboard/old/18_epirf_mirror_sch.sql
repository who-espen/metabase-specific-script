...
FROM
    ...
    left join public.v_espen_tz_sch_sth_impact_2405_3_kato_katz_full k on p.p_barcode_id = k.k_barcode_id
    left join public.v_espen_tz_sch_sth_impact_2405_4_urine_filtration_full u on p.p_barcode_id = u.u_espen_code_id
