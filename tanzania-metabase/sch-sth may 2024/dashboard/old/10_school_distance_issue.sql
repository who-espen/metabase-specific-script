 ...
 * Variable to rename v_espen_tz_sch_sth_impact_2405_1_school, <%village_dist_required%>
 */
...
FROM
    v_espen_tz_sch_sth_impact_2405_1_school src
    JOIN v_espen_tz_sch_sth_impact_2405_1_school dest on (
        SELECT
            calculate_distance(
                src.w_gps_lat,
                src.w_gps_lng,
