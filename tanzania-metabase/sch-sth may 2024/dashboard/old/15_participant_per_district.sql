 ...
 * Variable to rename v_espen_tz_sch_sth_impact_2405_2_child, v_espen_tz_sch_sth_impact_2405_1_school
 */
...
FROM
    ...
    LEFT JOIN v_espen_tz_sch_sth_impact_2405_1_school w on w.w_school_id = p.p_school_id
