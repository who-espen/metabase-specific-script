...
INITCAP(p_ward) "Ward"
FROM
    public.v_espen_tz_sch_sth_impact_2405_2_child p

left join public.v_espen_tz_sch_sth_impact_2405_1_school w on w.w_site = p.p_site
left join public.v_espen_tz_sch_sth_impact_2405_3_kato_katz k on k.k_barcode_id = p.p_barcode_id
left join public.v_espen_tz_sch_sth_impact_2405_4_urine_filtration u on u.u_code_id = p.p_barcode_id
