 ...
 * Variable to rename metabase_tz_sch_sth_202405_ia_duplicates, v_espen_tz_sch_sth_impact_2405_2_child, v_espen_tz_sch_sth_impact_2405_3_kato_katz,
...
FROM
    metabase_tz_sch_sth_202405_ia_duplicates AS m,
    v_espen_tz_sch_sth_impact_2405_3_kato_katz AS k
...
FROM
    metabase_tz_sch_sth_202405_ia_duplicates AS m,
    v_espen_tz_sch_sth_impact_2405_4_urine_filtration AS u
WHERE
