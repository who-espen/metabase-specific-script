 ...
 * Variable to rename v_espen_tz_sch_sth_impact_202311_1_school_v4, <%village_dist_required%>
 */
...
FROM
    v_espen_tz_sch_sth_impact_202311_1_school_v4 src
    JOIN v_espen_tz_sch_sth_impact_202311_1_school_v4 dest on (
        SELECT
            calculate_distance(
                src.w_gps_lat,
                src.w_gps_lng,
